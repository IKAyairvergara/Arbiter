DROP PROCEDURE IF EXISTS PROC_CONS_OTROS_FLUJOS;
DELIMITER //
CREATE PROCEDURE PROC_CONS_OTROS_FLUJOS()
-- ------------------------------------------------------------------------------------------------------------
...
BEGIN
 ...
 DECLARE v_ofl_c_costo_construccion			                                   decimal(15,5); 
 DECLARE v_ofl_c_honorarios_colpatria			                               decimal(15,5); 
 DECLARE v_ofl_c_gastos_operacion_colpatria		                               decimal(15,5); 
 DECLARE v_ofl_c_go_promotora_operacion			                               decimal(15,5); 
 DECLARE v_ofl_c_go_promotora_overhead			                               decimal(15,5); 
 DECLARE v_ofl_c_go_constructora_operacion		                               decimal(15,5); 
 DECLARE v_ofl_c_go_constructora_overhead			                           decimal(15,5); 
 DECLARE v_ofl_c_go_transacciones_inmobiliarias_operacion	                   decimal(15,5); 
 DECLARE v_ofl_c_go_transacciones_inmobliarias_overhead                        decimal(15,5); 
 DECLARE v_ofl_c_otros_pagos_efectuados_por_fiducia	                           decimal(15,5); 
 DECLARE v_ofl_c_valor_terreno				                                   decimal(15,5); 
 DECLARE v_ofl_c_egresos_credito_constructor		                           decimal(15,5); 
 DECLARE v_ofl_c_impuesto_transacciones_financieras_colpatria	               decimal(15,5); 
 DECLARE v_ofl_c_comision_fiduciaria_nuevogar_sin_fiduciaria	               decimal(15,5); 
 DECLARE v_ofl_c_otros_costos_y_gastos			                               decimal(15,5); 
 DECLARE v_ofl_c_aportes_efectivo_colpatria_fideicomisos	                   decimal(15,5); 
 DECLARE v_ofl_c_reintegros_iva				                                   decimal(15,5); 
 DECLARE v_ofl_c_subtotal_egresos_colpatria		                               decimal(15,5); 
 DECLARE v_ofl_c_traslados_fiducias_e_ingresos_totales	                       decimal(15,5); 
 DECLARE v_ofl_c_ingresos_ventas_colpatria		                               decimal(15,5); 
 DECLARE v_ofl_c_desembolsos_credito_constructor_terreno	                   decimal(15,5); 
 DECLARE v_ofl_c_traslados_liquidaciones_fideicomisos	                       decimal(15,5); 
 DECLARE v_ofl_c_otros_ingresos				                                   decimal(15,5); 
 DECLARE v_ofl_c_aportes_de_socios			                                   decimal(15,5); 
 DECLARE v_ofl_c_subtotal_ingresos			                                   decimal(15,5); 
 DECLARE v_ofl_c_flujo_caja_antes_de_reintegro_socios	                       decimal(15,5); 
 DECLARE v_ofl_c_reintegro_aportes_utilidades_socios	                       decimal(15,5); 
 DECLARE v_ofl_c_flujo_neto_caja_ct			                                   decimal(15,5); 
 DECLARE v_ofl_c_flujo_acumulado				                               decimal(15,5); 
 DECLARE v_ofl_c_costo_credito_tesoreria			                           decimal(15,5); 
 DECLARE v_ofl_c_impuesto_renta				                                   decimal(15,5); 
 DECLARE v_ofl_c_flujo_neto_caja				                               decimal(15,5); 
 DECLARE v_ofl_c_flujo_acumulado_caja			                               decimal(15,5); 
 DECLARE v_ofl_c_vpn					                                       decimal(15,5); 
 DECLARE v_ofl_c_tir_ea					                                       decimal(15,5); 
 DECLARE v_ofl_c_tir_em					                                       decimal(15,5); 
 DECLARE v_ofl_c_tir_mod_ea				                                       decimal(15,5); 
 DECLARE v_ofl_c_tir_mod_em				                                       decimal(15,5); 
 DECLARE v_ofl_c_valor_total_ventas			                                   decimal(15,5); 
 DECLARE v_ofl_c_pagos_efectuados_fiducia_admon		                           decimal(15,5); 
 DECLARE v_ofl_c_pe_intereses_credito_constructor		                       decimal(15,5); 
 DECLARE v_ofl_c_pe_honorarios_visitas_obra_otros		                       decimal(15,5); 
 DECLARE v_ofl_c_pe_abonos_extraordinarios_credito	                           decimal(15,5); 
 DECLARE v_ofl_c_pe_pagos_terreno_efectuados_fiducia	                       decimal(15,5); 
 DECLARE v_ofl_c_pe_otros_pagos_efectuados_fiducia	                           decimal(15,5); 
 DECLARE v_ofl_c_traslados_fondos_fiducia_constructora	                       decimal(15,5); 
 DECLARE v_ofl_c_comision_fiduciaria_prreventas_admon	             		   decimal(15,5); 
 DECLARE v_ofl_c_comision_fiduciaria_nuevogar		                           decimal(15,5); 
 DECLARE v_ofl_c_impuesto_transacciones_financieras	                           decimal(15,5); 
 DECLARE v_ofl_c_subtotal_egresos				                               decimal(15,5); 
 DECLARE v_ofl_c_desembolsos_credito_constructor		                       decimal(15,5); 
 DECLARE v_ofl_c_ingresos_ventas				                               decimal(15,5); 
 DECLARE v_ofl_c_iv_abonos_separacion			                               decimal(15,5); 
 DECLARE v_ofl_c_iv_cartera_cuota_inicial			    					   decimal(15,5); 
 DECLARE v_ofl_c_iv_saldo_cuota_inicial_abono_escritura						   decimal(15,5); 
 DECLARE v_ofl_c_iv_subsidio_vis_y_ahorro_programado						   decimal(15,5); 
 DECLARE v_ofl_c_iv_excedentes_credito_compradores							   decimal(15,5); 
 DECLARE v_ofl_c_iv_giros_directos_creditos_otras_entidades	 				   decimal(15,5); 
 DECLARE v_ofl_c_iv_ingresos_por_recibir_ventas_realizadas					   decimal(15,5); 
 DECLARE v_ofl_c_otros_ingresos_por_ventas								  	   decimal(15,5); 
 DECLARE v_ofl_c_oi_intereses_subrogacion									   decimal(15,5); 
 DECLARE v_ofl_c_oi_intereses_mora											   decimal(15,5); 
 DECLARE v_ofl_c_oi_ofertas_comerciales_y_otros_ingresos					   decimal(15,5); 
 DECLARE v_ofl_c_aportes_efectivo_colpatria_fideicomiso						   decimal(15,5);
 DECLARE v_ofl_c_aportes_otros_socios_inversionistas						   decimal(15,5); 
 DECLARE v_ofl_c_rendimientos_fideicomiso_capitalizacion					   decimal(15,5); 
 DECLARE v_ofl_c_subtotal_ingresos_antes_rendimientos					       decimal(15,5); 
 DECLARE v_ofl_c_flujo_neto_sin_rendimientos							 	   decimal(15,5); 
 DECLARE v_ofl_c_rendimientos_fideicomiso									   decimal(15,5); 
 DECLARE v_ofl_c_flujo_neto_fiduciaria										   decimal(15,5); 
 DECLARE v_ofl_c_traslado_saldo_final_fiducia_liquidacion					   decimal(15,5); 
 DECLARE v_ofl_c_flujo_acumulado_fiduciaria								       decimal(15,5);
 

  DECLARE  v_ofl_c_consolidado 																			VARCHAR(12) ;
  DECLARE v_ofl_c_periodo 																			    INT(6);
  DECLARE v_ofl_c_fecha_periodo  																			date;
  DECLARE v_ofl_c_contador  																			    INTEGER DEFAULT 1;
  DECLARE v_ofl_c_i  																			 			INTEGER DEFAULT 1;
...
-- SVSB
 ...
 DECLARE c_fecha CURSOR FOR
   select OFL_C_FECHA
    ...
    where OFL_C_CONS_ID = v_ofl_c_cons_id;
...
FROM (
    ...
    ,OFL_FECHA								                                               OFL_C_FECHA
 	...
 	,SUM(OFL_GO_CONSTRUCTORA_OPERACION)			                                           OFL_C_GO_CONSTRUCTORA_OPERACION
 	...
 	,SUM(OFL_DESEMBOLSOS_CREDITO_CONSTRUCTOR)		                                       OFL_C_DESEMBOLSOS_CREDITO_CONSTRUCTOR
	  ...
	  ,SUM(OFL_IV_ABONOS_SEPARACION)                                                       OFL_C_IV_ABONOS_SEPARACION
	  ,SUM(OFL_IV_CARTERA_CUOTA_INICIAL)                                                   OFL_C_IV_CARTERA_CUOTA_INICIAL
	  ,SUM(OFL_IV_SALDO_CUOTA_INICIAL_ABONO_ESCRITURA)                                     OFL_C_IV_SALDO_CUOTA_INICIAL_ABONO_ESCRITURA
	  ,SUM(OFL_IV_SUBSIDIO_VIS_Y_AHORRO_PROGRAMADO)                                        OFL_C_IV_SUBSIDIO_VIS_Y_AHORRO_PROGRAMADO
	  ,SUM(OFL_IV_EXCEDENTES_CREDITO_COMPRADORES)                                          OFL_C_IV_EXCEDENTES_CREDITO_COMPRADORES
	  ,SUM(OFL_IV_GIROS_DIRECTOS_CREDITOS_OTRAS_ENTIDADES)                                 OFL_C_IV_GIROS_DIRECTOS_CREDITOS_OTRAS_ENTIDADES
	  ,SUM(OFL_IV_INGRESOS_POR_RECIBIR_VENTAS_REALIZADAS)                                  OFL_C_IV_INGRESOS_POR_RECIBIR_VENTAS_REALIZADAS
...
UNION ALL
    ...
    ,OFL_C_FECHA								                                            OFL_C_FECHA
 	,SUM(OFL_C_COSTO_CONSTRUCCION)				                                            OFL_C_COSTO_CONSTRUCCION
 	...
 	,SUM(OFL_C_IV_ABONOS_SEPARACION)				                                        OFL_C_IV_ABONOS_SEPARACION
 	,SUM(OFL_C_IV_CARTERA_CUOTA_INICIAL)			                                        OFL_C_IV_CARTERA_CUOTA_INICIAL
 	,SUM(OFL_C_IV_SALDO_CUOTA_INICIAL_ABONO_ESCRITURA)	                                    OFL_C_IV_SALDO_CUOTA_INICIAL_ABONO_ESCRITURA
 	,SUM(OFL_C_IV_SUBSIDIO_VIS_Y_AHORRO_PROGRAMADO)		                                    OFL_C_IV_SUBSIDIO_VIS_Y_AHORRO_PROGRAMADO
 	,SUM(OFL_C_IV_EXCEDENTES_CREDITO_COMPRADORES)		                                    OFL_C_IV_EXCEDENTES_CREDITO_COMPRADORES
 	,SUM(OFL_C_IV_GIROS_DIRECTOS_CREDITOS_OTRAS_ENTIDADES)	                                OFL_C_IV_GIROS_DIRECTOS_CREDITOS_OTRAS_ENTIDADES
 	,SUM(OFL_C_IV_INGRESOS_POR_RECIBIR_VENTAS_REALIZADAS)	                                OFL_C_IV_INGRESOS_POR_RECIBIR_VENTAS_REALIZADAS
  ...
  -- SVSB
SET v_finished = 0;
-- SET v_ofl_c_consolidado = v_ofl_c_cons_id; 

select cons_per
  into v_ofl_c_periodo
  from tb_consolidados
 where cons_id = v_ofl_c_cons_id;

OPEN c_fecha;
 obtener_fecha:LOOP
  FETCH c_fecha into v_ofl_c_fecha_periodo;
  
  IF v_finished = 1 THEN
     LEAVE obtener_fecha;
  END IF;   
  
  UPDATE tb_c_otros_flujos
     SET OFL_C_PERIODICIDAD = v_ofl_c_contador
   WHERE OFL_C_FECHA = v_ofl_c_fecha_periodo
     AND OFL_C_CONS_ID = v_ofl_c_cons_id;
  
  if v_ofl_c_i = v_ofl_c_periodo then
   SET v_ofl_c_contador = v_ofl_c_contador + 1;
   SET v_ofl_c_i = 0;
  end if;
  SET v_ofl_c_i = v_ofl_c_i+1;  

  END LOOP obtener_fecha;
 CLOSE c_fecha;  
