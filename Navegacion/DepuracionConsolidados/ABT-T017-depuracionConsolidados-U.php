...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p" onclick="location.href='../Depuracion/ABT-T016-depuracion.php';" style="background-image:url(Untitled-1_03.png);" title="">
	</div>
	<div style="background-image:url(Untitled-1_04.png); position:absolute; left:804px; top:42px; width:32px; height:116px;" title="">
	</div>
	<div id="p1" onclick="location.href='../Bienvenido/ABT-T010-bienvenido.php';" style="background-image:url(Untitled-1_05.png);" title="">
	</div>
	...
	<form method="post" action="ABT-T064-seleccionDepuracionConsolidados-U.php">
