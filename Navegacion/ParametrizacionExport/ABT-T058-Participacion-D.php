<?php
    ...
    $consulta = "SELECT `PAR_ID`, `PAR_DESCRIPCION` FROM `tb_participacion` WHERE 1";
	...
	if($resultado->num_rows > 0 ){
		...
		$objPHPExcel->setActiveSheetIndex(0)
			...
			$objPHPExcel->setActiveSheetIndex(0) 
			->setCellValue('A'.$c,   $fila["PAR_ID"])
			->setCellValue('B'.$c,   $fila["PAR_DESCRIPCION"])
			;
			$c=$c+1;
			}	
	...
	$objPHPExcel->getActiveSheet()->getColumnDimensionByColumn(3)->setAutoSize(true);   
		...
		$objPHPExcel->getActiveSheet()->setTitle('Participacion');
		...
		header('Content-Disposition: attachment;filename="ExportParticipacion.xlsx"');
