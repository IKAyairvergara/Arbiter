...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onClick="location.href='../Participacion/ABT-T043-participacion-D.php';" style="background-image:url(editar2_08.png); " title="">
	</div>
	...
	<br>
	<center>
	<form id="form1" name="form1" method="post" action="ABT-T024-editarParticipacion-U.php">
  <table class="tabla">
  <tr>
  ...
  <tr>
	...
	$PAR_DESCRIPCION=$_POST['PAR_DESCRIPCION'];   
		...
		if($result==true){
			print "<script>alert(\"no se a podido realizar el cambio\");window.location='ABT-T024-editarParticipacion-U.php';</script>";
			}
		else{
			print "<script>alert(\"\Cambio realizado con exito\");window.location='../Participacion/ABT-T043-participacion-D.php';</script>";
			}
		}
	$mysqli->close();
	?>
