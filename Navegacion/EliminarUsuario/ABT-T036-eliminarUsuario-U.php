...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" style="background-image:url(eliminar_05.png);" onclick="location.href='../Administrador/ABT-T001-administrador-D.php'" title="">
	</div>
	...
	<br>
	<center>
	<form role="form" name="registro" action="ABT-T036-eliminarUsuario-U.php" method="post">
            <div>
     ...
     <?php 
	    ...
	    if(isset($_POST['username'])){
		  ...
		  $result = $mysqli->query($query);
	       if($result==false){
				print "<script>alert(\"El registro no puede ser eliminado \");window.location='ABT-T036-eliminarUsuario-U.php';</script>";
				}
				else{
				print "<script>alert(\"Se ha Eliminado correctamente\");window.location='../Administrador/ABT-T001-administrador-D.php';</script>";
							}
			}
	     }
