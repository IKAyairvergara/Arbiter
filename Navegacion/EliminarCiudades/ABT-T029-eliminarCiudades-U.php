...
<body>
	<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
		...
		<div id="p1" onClick="location.href='../Ciudades/ABT-T014-ciudades-D.php';" style="background-image:url(eliminar_05.png); " title="">
		</div>
		...
		<div style="background-image:url(eliminar_13.png); position:absolute; left:36px; top:158px; width:954px; height:494px;" title="">
			...
			<br>
			<center>
				<form method = "post" action = "ABT-T029-eliminarCiudades-U.php">
