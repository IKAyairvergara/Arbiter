...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onClick="location.href='../Servidores/ABT-T049-servidores-D.php';" style="background-image:url(eliminar_05.png); " title="">
	</div>
	...
	<form method = "post" >
                  <table width = "400" border = "0" cellspacing = "1" 
                     ...
                     <tr>
                        <td style="color: white; font-family:sans-serif;font-size:20;" width = "100">Ruta:</td>
    					<td><label for="SERV_ID"></label>
                        <select name='SERV_ID' id='SERV_ID'> 
                        <?php
	...
	$SERV_ID=$_POST['SERV_ID'];}
	    ...
	    if(isset($_POST['SERV_ID'])){
	      ...
	      $query = "DELETE FROM tb_servidor WHERE ser_ruta= '$SERV_ID'";
		  $result = $mysqli->query($query);
	       if($result==false){
				print "<script>alert(\"El registro no puede ser eliminado ya que contiene dependencias\");window.location='ABT-T032-eliminarPaises-U.php';</script>";
				}
				else{
				print "<script>alert(\"Se ha Eliminado correctamente\");window.location='../Servidores/ABT-T049-servidores-D.php';</script>";
							}
			}
	     }
