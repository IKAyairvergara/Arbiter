<!-- 
=======================================================================================================================
==> TITULO DE ARCHIVO: depuracion.php

==> DESCRIPCION: Pantalla que permite visualizar y depurar los proyectos y consolidados parametrizados en el sistema.
...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p" onclick="location.href='../Bienvenido/bienvenido.php';"  style="background-image:url(depuracion_03.png); " title="">
	</div>
	<div style="background-image:url(depuracion_04.png); position:absolute; left:802px; top:31px; width:19px; height:737px;" title="">
	</div>
	<div id="p1" onclick="location.href='../Bienvenido/bienvenido.php';"  style="background-image:url(depuracion_05.png); " title="">
	</div>
	...
	<div id="p3" onClick="location.href='../DepuracionConsolidados/depuracionConsolidados.php';" style="background-image:url(depuracion_13.png);" title="">
	</div>
