<?php	
		...
		require "ABT-T018-depuracionProyectos-U.php";
		include "../../php/ABT-T000-conexion-U.php";	
			...
			for ($i=0; $i<sizeof($checkBox); $i++)
			   ...
			   if($resultados){
				print "<script>alert(\"\Depuracion Exitosa $i Campos Borrados\");window.location='ABT-T018-depuracionProyectos-U.php';</script>";
				}
			    else{
				print "<script>alert(\"ERROR NO HA SELECCIONADO NINGUNA CASILLA!\");window.location='ABT-T018-depuracionProyectos-U.php';</script>";
				}
