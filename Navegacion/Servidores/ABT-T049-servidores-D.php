...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p" onClick="location.href='../Parametrizacion/ABT-T042-parametrizacion-D.php';"  style="background-image:url(servidores_03.png); " title="">
	</div>
	<div style="background-image:url(servidores_04.png); position:absolute; left:802px; top:35px; width:19px; height:123px;" title="">
	</div>
	<div id="p1" onClick="location.href='../Bienvenido/ABT-T010-bienvenido.php';" style="background-image:url(servidores_05.png); " title="">
	</div>
