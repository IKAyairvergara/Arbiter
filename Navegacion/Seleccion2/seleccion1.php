...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<input type="submit" name="enviar" id="enviar" value="Enviar">
		...
		<div onclick="location.href='../Bienvenido/bienvenido.php';" style="background-image:url(Seleccion_03.png); position:absolute; left:639px; top:39px; width:162px; height:76px; opacity: 1.0; filter: alpha(opacity=100); transform: scale(1.12); transition-duration: 0.4s;" title="">
		</div>
		<div onclick="location.href='../Bienvenido/bienvenido.php';" style="background-image:url(Seleccion_04.png); position:absolute; left:801px; top:39px; width:32px; height:154px;" title="">
		</div>
		<div onclick="location.href='../Bienvenido/bienvenido.php';" style="background-image:url(Seleccion_05.png); position:absolute; left:833px; top:39px; width:154px; height:76px; opacity: 1.0; filter: alpha(opacity=100); transform: scale(1.12); transition-duration: 0.4s;" title="">
		</div>
		...
		<div style="background-image:url(Seleccion_10.png); position:absolute; left:218px; top:193px; width:111px; height:30px;" title="">
		
			<input type="date" name="genedesde" id="genedesde" style="left:218px; top:193px; width:120px; height:30px;" required />

		</div>
		<div style="background-image:url(Seleccion_11.png); position:absolute; left:329px; top:193px; width:40px; height:299px;" title="">
		</div>
		<div style="background-image:url(Seleccion_12.png); position:absolute; left:369px; top:193px; width:111px; height:30px;" title="">
				
			<input type="date" name="genehasta" style="left:369px; top:193px; width:120px; height:30px;" required/>
		...
		<div style="background-image:url(Seleccion_19.png); position:absolute; left:218px; top:242px; width:111px; height:30px;" title="">
		
			<input type="date" name = "ventasdesde" style ="left:218px; top:242px; width:130px; height:30px;" required/>

		</div>
		<div style="background-image:url(Seleccion_20.png); position:absolute; left:369px; top:242px; width:111px; height:30px;" title="">
		...
		<div style="background-image:url(Seleccion_25.png); position:absolute; left:218px; top:290px; width:111px; height:31px;" title="">
			
			<input type="date" name="constdesde" style="left:218px; top:290px; width:130px; height:31px;" required />

		</div>
		<div style="background-image:url(Seleccion_26.png); position:absolute; left:369px; top:290px; width:111px; height:31px;" title="">
		...
		<div style="background-image:url(Seleccion_27.png); position:absolute; left:800px; top:290px; width:181px; height:31px;" title="">
			...
			<input type="text" name="monedareexpresion" id="monedaree" maxlength="4" onKeyUp="javascript:this.value=this.value.toUpperCase();" onkeypress="return justNumbers(event);"  style="left:800px; top:244px; width:190px; height:30px;" required/>
		...
		<div style="background-image:url(Seleccion_31.png); position:absolute; left:218px; top:340px; width:111px; height:30px;" title="">
		
			<input type="date" name="prepdesde" style="left:218px; top:340px; width:130px; height:30px;" required />

		</div>
		<div style="background-image:url(Seleccion_32.png); position:absolute; left:369px; top:340px; width:111px; height:30px;" title="">
		...
		<div style="background-image:url(Seleccion_39.png); position:absolute; left:800px; top:435px; width:181px; height:30px;" title="">
			...
			<input type="text" maxlength="4" name="proyecto" onKeyUp="javascript:this.value=this.value.toUpperCase();" style="left:800px; top:435px; width:190px; height:30px;" required/>
		...
		<div style="background-image:url(Seleccion_41.png); position:absolute; left:800px; top:487px; width:181px; height:30px;" title="">
			...
			<input type="text" name="version" maxlength="2" onKeyUp="javascript:this.value=this.value.toUpperCase();" style="left:800px; top:487px; width:190px; height:30px;" required/>

		</div>
		<div style="background-image:url(Seleccion_42.png); position:absolute; left:0px; top:492px; width:59px; height:194px;" title="">
		</div>
		<div onclick="location.href='../SeleccionProyectos/seleccionProyectos.php';" style="background-image:url(Seleccion_43.png); position:absolute; left:59px; top:492px; width:108px; height:36px;" title="">
		</div>
		<div style="background-image:url(Seleccion_44.png); position:absolute; left:167px; top:492px; width:29px; height:194px;" title="">
		</div>
		<div onclick="location.href='../SeleccionModelos/seleccionModelos.php';" style="background-image:url(Seleccion_45.png); position:absolute; left:196px; top:492px; width:109px; height:36px;" title="">
		</div>
		<div style="background-image:url(Seleccion_46.png); position:absolute; left:305px; top:492px; width:36px; height:86px;" title="">
		</div>
		<div onclick="location.href='../filtroAvanzado3/filtroAvanzado.php';" style="background-image:url(Seleccion_47.png); position:absolute; left:341px; top:492px; width:148px; height:36px;" title="">
		</div>
		...
		<div onclick="location.href='http://modelo-c.ditscol.com';" style="background-image:url(Seleccion_57.png); position:absolute; left:53px; top:686px; width:172px; height:49px; opacity: 1.0; filter: alpha(opacity=100); transform: scale(1.12); transition-duration: 0.4s;" title="">
		</div>
		<div style="background-image:url(Seleccion_58.png); position:absolute; left:225px; top:686px; width:63px; height:82px;" title="">
		</div>
		<div onclick="location.href='../Bienvenido/bienvenido.php';" style="background-image:url(Seleccion_59.png); position:absolute; left:288px; top:686px; width:173px; height:49px; opacity: 1.0; filter: alpha(opacity=100); transform: scale(1.12); transition-duration: 0.4s;" title="">
		</div>
