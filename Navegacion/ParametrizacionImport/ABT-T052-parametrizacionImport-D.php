				...
				//verificacion si se ha subido un archivo
							...
							include "../../php/ABT-T000-conexion-U.php";	
    							...
    							if($sel== '1'){
									...
									$nombre= $objPHPExcel->getActiveSheet()->getCellByColumnAndRow(0, 1)->getValue();	
								...
								if(!$resultado_pai= $mysqli -> query($insert_pai)){
									  ...
									  $error=' ' . $mysqli->error;    $insert_dupli=$insert_dupli+1;
