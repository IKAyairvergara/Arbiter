...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<br>
	<center>
		<form id="form1" name="form1" method="post" action="ABT-T005-agregarPaises-U.php">
	  <table class="tabla">
	  <tr>
		...
		<?php 
		    ...
		    if(isset($_POST['PAIS_ID'])&&isset($_POST['PAIS_DESCRIPCION'])){
				...
				if($_POST["PAIS_ID"]!=""&& $_POST["PAIS_DESCRIPCION"]!=""){
					...
					if($result==false){
						print "<script>alert(\"Registro duplicado\");window.location='ABT-T005-agregarPaises-U.php';</script>";
							}
						else{
							print "<script>alert(\"los datos se enviaron correctamente\");window.location='../Paises/ABT-T041-paises-D.php';</script>";
							}
						}
					}
