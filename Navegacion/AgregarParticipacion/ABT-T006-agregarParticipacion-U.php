...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onClick="location.href='../Participacion/ABT-T043-participacion-D.php';" style="background-image:url(agregar_03.png); " title="">
	</div>
	...
	<br>
	<br>
	<form id="form1" name="form1" method="post" action="ABT-T006-agregarParticipacion-U.php">
	  <table class="tabla">
	  <tr>
		...
		<?php 
		    ...
		    if(isset($_POST['CIUD_ID'])&& isset($_POST["CIUD_DESCRIPCION"])){
				...
				if($_POST["CIUD_ID"]!=""&& $_POST["CIUD_DESCRIPCION"]!=""){					
					...
					if($result==false){
							print "<script>alert(\"los datos estan duplicados\");window.location='ABT-T006-agregarParticipacion-U.php';</script>";
							}
							else{
							print "<script>alert(\"los datos se enviaron correctamente\");window.location='../Participacion/ABT-T043-participacion-D.php';</script>";
							}
