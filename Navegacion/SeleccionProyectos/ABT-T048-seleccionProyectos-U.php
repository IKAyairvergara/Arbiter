...
<form method="post"  action="ABT-T067-envioSeleccionProyectos-U.php">
	...
	<div id="p" onclick="location.href='../Seleccion/ABT-T046-seleccion.php';" style="background-image:url(proyectos_03.png);" title="">
	</div>
	<div style="background-image:url(proyectos_04.png); position:absolute; left:802px; top:41px; width:32px; height:117px;" title="">
	</div>
	<div id="p1" onclick="location.href='../Bienvenido/ABT-T010-bienvenido.php';" style="background-image:url(proyectos_05.png);" title="">
	</div>
