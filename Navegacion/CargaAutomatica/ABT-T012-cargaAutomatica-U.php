...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" style="background-image:url(carga-automatica_03.png);" onclick="location.href='../Carga/ABT-T011-carga-U.php'" title="">
	</div>
	...
	<div id="p2" style="background-image:url(carga-automatica_05.png);" onclick="location.href='../Bienvenido/ABT-T010-bienvenido.php'" title="">
	</div>
				...
				//verificacion si se ha subido un archivo
					...
					$errorproyecto++;
							...
							if(!$resultado_mod= $mysqli -> query($envio_Tb_modelos)){
								$error_insert=$error_insert+1;//		echo('There was an error running the query [' . $mysqli->error . '].</br>');
