...
echo 'Sobreescritos '. $sobre. '<br>';
echo 'Error Proyecto No existe '.$errorproyecto. '<br>';
echo 'Error Nombre Invalido '.$errornombre. '<br>';
echo 'Error tipo archivo '.$errortipo. '<br>';
echo 'Error Etapa no exite '.$erroretapa. '<br>';
echo 'Error al encontrar una hoja'. $errorfind. '<br>';
echo $count. '<br>';
echo 'Archivos exitosos '.$exito. '<br>';
}
	...
	function cambiarFecha($fecha){
				...
				function Resumen($objPHPExcel,$check_model,$proyecto,$etapa,$modelo,$mysqli){
					...
					if($res_total_unidades==null){
						$res_total_unidades=0;
								...
								if($res_area_promedio_unidad==null){
									$res_area_promedio_unidad=0;
								}
								...
								if($res_area_util_lote_asignada_subproyecto==null){
									$res_area_util_lote_asignada_subproyecto=0;
								}
								if($res_densidad_indice_ocupacion==null){
									$res_densidad_indice_ocupacion=0;
								}
								if($res_valor_metro_cuadrado_lote_urbanizado==null){
									$res_valor_metro_cuadrado_lote_urbanizado=0;
								}
								if($res_numero_parqueos==null){
									$res_numero_parqueos=0;
								}
								if($res_relacion_parqueos_numero_parqueos_por_unidad==null){
									$res_relacion_parqueos_numero_parqueos_por_unidad=0;
								}
								if($res_numero_depositos==null){
									$res_numero_depositos=0;
								}
								if($res_fecha_inicio_y_terminacion_ventas==null){
									$res_fecha_inicio_y_terminacion_ventas=0;
								}
								if($res_fecha_inicio_y_terminacion_construccion==null){
									$res_fecha_inicio_y_terminacion_construccion=0;
								}
								if($res_ritmo_ventas_mensual_promedio==null){
									$res_ritmo_ventas_mensual_promedio=0;
								}
								if($res_punto_equilibrio_unidades==null){
									$res_punto_equilibrio_unidades=0;
								}
								if($res_tasa_promedio_incremento_precios==null){
									$res_tasa_promedio_incremento_precios=0;
								}
								if($res_porcentaje_ventas_nuevogar==null){$res_porcentaje_ventas_nuevogar=0;
								}
								if($res_fecha_presupuesto==null){
									$res_fecha_presupuesto=0;
								}
								
								if($res_tasa_promedio_incremento_presupuesto==null){
									$res_tasa_promedio_incremento_presupuesto=0;
								}
			...
			//----------------------------------RESUMEN---------------------
							...
							$envio_Tb_Resumen="INSERT INTO TB_RESUMEN (RES_DET_PRO_ID,RES_DET_ETAPA,
								RES_MODELO,RES_FECHA,RES_TOTAL_UNIDADES,
							...
							VALUES ('$res_id',$res_det_etapa,'$res_modelo','$res_fecha',$res_total_unidades,
								$res_area_promedio_unidad,
								$res_total_area_construida,
								$res_total_area_vendible,
								$res_area_util_lote_asignada_subproyecto,
					...
					if($res_total_unidades==null){
						$res_total_unidades=0;
								...
								if($res_fecha_inicio_f_ventas==null){
									$res_fecha_inicio_f_ventas=0;
								}
								if($res_fecha_inicio_f_construccion==null){
									$res_fecha_inicio_f_construccion=0;
								}
								if($res_ritmo_ventas==null){
									$res_ritmo_ventas=0;
								}
								if($res_punto_equilobrio==null){
									$res_punto_equilobrio=0;
								}
								if($res_tasa_promedio_precios==null){
									$res_tasa_promedio_precios=0;
								}
								if($res_ventas_nuevo_hogar==null){$res_ventas_nuevo_hogar=0;
								}
								if($res_fecha_presupuesto==null){
									$res_fecha_presupuesto=0;
								}
								
								if($res_tasa_promedio_incremento==null){
									$res_tasa_promedio_incremento=0;
								}
								if($res_c_tot_ui==null){
									$res_c_tot_ui=0;
								}
								...
								if($res_c_eje_ui==null){$res_c_eje_ui=0;}
								if($res_c_eje_uip==null){$res_c_eje_uip=0;}
								if($res_c_eje_uii==null){$res_c_eje_uii=0;}
								if($res_c_eje_cm==null){$res_c_eje_cm=0;}
								if($res_c_eje_cmp==null){$res_c_eje_cmp=0;}
								if($res_c_eje_cmi==null){$res_c_eje_cmi=0;}
								if($res_c_eje_gi==null){$res_c_eje_gi=0;}
								if($res_c_eje_cp==null){$res_c_eje_cp=0;}
								if($res_c_eje_cd==null){$res_c_eje_cd=0;}
								if($res_c_eje_cd_hc==null){$res_c_eje_cd_hc=0;}
								if($res_c_eje_cd_hc_hc==null){$res_c_eje_cd_hc_hc=0;}
								if($res_c_eje_cd_hc_gr==null){$res_c_eje_cd_hc_gr=0;}
								if($res_c_eje_cd_hi==null){$res_c_eje_cd_hi=0;}
								if($res_c_eje_cd_hi_hi==null){$res_c_eje_cd_hi_hi=0;}
								if($res_c_eje_cd_hi_gr==null){$res_c_eje_cd_hi_gr=0;}
								if($res_c_eje_cd_oh==null){$res_c_eje_cd_oh=0;}
								if($res_c_eje_cd_oh_oh==null){$res_c_eje_cd_oh_oh=0;}
								if($res_c_eje_cd_oh_gr==null){$res_c_eje_cd_oh_gr=0;}
								if($res_c_eje_cd_id==null){$res_c_eje_cd_id=0;}
								if($res_c_eje_ct==null){$res_c_eje_ct=0;}
								if($res_c_eje_ct_hg==null){$res_c_eje_ct_hg=0;}
								if($res_c_eje_ct_hg_hg==null){$res_c_eje_ct_hg_hg=0;}
								if($res_c_eje_ct_hg_gr==null){$res_c_eje_ct_hg_gr=0;}
								if($res_c_eje_ct_hv==null){$res_c_eje_ct_hv=0;}
								if($res_c_eje_ct_hv_hv==null){$res_c_eje_ct_hv_hv=0;}
								if($res_c_eje_ct_hv_gr==null){$res_c_eje_ct_hv_gr=0;}
								if($res_c_eje_ct_cp==null){$res_c_eje_ct_cp=0;}
								if($res_c_eje_ct_cp_sv==null){$res_c_eje_ct_cp_sv=0;}
								if($res_c_eje_ct_cp_gp==null){$res_c_eje_ct_cp_gp=0;}
								if($res_c_eje_ct_cp_gs==null){$res_c_eje_ct_cp_gs=0;}
								if($res_c_eje_ct_cp_au==null){$res_c_eje_ct_cp_au=0;}
								if($res_c_eje_ct_cp_cv==null){$res_c_eje_ct_cp_cv=0;}
								if($res_c_eje_ct_gl==null){$res_c_eje_ct_gl=0;}
								if($res_c_eje_ct_gl_hc==null){$res_c_eje_ct_gl_hc=0;}
								if($res_c_eje_ct_gl_nr==null){$res_c_eje_ct_gl_nr=0;}
								if($res_c_eje_ct_gl_ip==null){$res_c_eje_ct_gl_ip=0;}
								if($res_c_eje_ct_gl_ic==null){$res_c_eje_ct_gl_ic=0;}
								if($res_c_eje_ca==null){$res_c_eje_ca=0;}
								if($res_c_eje_ca_vt==null){$res_c_eje_ca_vt=0;}
								if($res_c_eje_ca_vt_pv==null){$res_c_eje_ca_vt_pv=0;}
								if($res_c_eje_ca_vt_op==null){$res_c_eje_ca_vt_op=0;}
								if($res_c_eje_ca_cf==null){$res_c_eje_ca_cf=0;}
								if($res_c_eje_ca_cf_pa==null){$res_c_eje_ca_cf_pa=0;}
								if($res_c_eje_ca_cf_nh==null){$res_c_eje_ca_cf_nh=0;}
								if($res_c_eje_ca_gf==null){$res_c_eje_ca_gf=0;}
								if($res_c_eje_ca_gf_ic==null){$res_c_eje_ca_gf_ic=0;}
								if($res_c_eje_ca_gf_oc==null){$res_c_eje_ca_gf_oc=0;}
								if($res_c_eje_ca_gf_cm==null){$res_c_eje_ca_gf_cm=0;}
								if($res_c_eje_ca_gf_it==null){$res_c_eje_ca_gf_it=0;}
								if($res_c_eje_ca_oc==null){$res_c_eje_ca_oc=0;}
								if($res_c_eje_ca_oc_oc1==null){$res_c_eje_ca_oc_oc1=0;}
								if($res_c_eje_ca_oc_oc2==null){$res_c_eje_ca_oc_oc2=0;}
								if($res_c_eje_ca_oc_oc3==null){$res_c_eje_ca_oc_oc3=0;}
								if($res_c_eje_ca_ri==null){$res_c_eje_ca_ri=0;}
								if($res_c_eje_ci==null){$res_c_eje_ci=0;}
								if($res_c_eje_ci_vb==null){$res_c_eje_ci_vb=0;}
								if($res_c_eje_ci_ov==null){$res_c_eje_ci_ov=0;}
								if($res_c_eje_ci_ov_is==null){$res_c_eje_ci_ov_is=0;}
								if($res_c_eje_ci_ov_im==null){$res_c_eje_ci_ov_im=0;}
								if($res_c_eje_ci_ov_oc==null){$res_c_eje_ci_ov_oc=0;}
								if($res_c_eje_ci_rf==null){$res_c_eje_ci_rf=0;}
								if($res_c_eje_ci_oi==null){$res_c_eje_ci_oi=0;}
								if($res_c_eje_ci_oi_oi1==null){$res_c_eje_ci_oi_oi1=0;}
								if($res_c_eje_ci_oi_oi2==null){$res_c_eje_ci_oi_oi2=0;}
								if($res_c_eje_ci_oi_oi3==null){$res_c_eje_ci_oi_oi3=0;}
								if($res_c_eje_it==null){$res_c_eje_it=0;}
								if($res_c_eje_up==null){$res_c_eje_up=0;}
								if($res_c_eje_up_cc==null){$res_c_eje_up_cc=0;}
								if($res_c_eje_up_ir==null){$res_c_eje_up_ir=0;}
								if($res_c_eje_up2==null){$res_c_eje_up2=0;}
								if($res_c_eje_cv==null){$res_c_eje_cv=0;}
								if($res_c_eje_vt==null){$res_c_eje_vt=0;}
								if($res_c_eje_uc==null){$res_c_eje_uc=0;}
								if($res_c_eje_uc_co==null){$res_c_eje_uc_co=0;}
								if($res_c_eje_uc_ti==null){$res_c_eje_uc_ti=0;}
								if($res_c_eje_uc_pr==null){$res_c_eje_uc_pr=0;}
								
								
																if($res_c_porc_tot_ui==null){$res_c_porc_tot_ui=0;}
								if($res_c_porc_tot_uip==null){$res_c_porc_tot_uip=0;}
								if($res_c_porc_tot_uii==null){$res_c_porc_tot_uii=0;}
								if($res_c_porc_tot_cm==null){$res_c_porc_tot_cm=0;}
								if($res_c_porc_tot_cmp==null){$res_c_porc_tot_cmp=0;}
								if($res_c_porc_tot_cmi==null){$res_c_porc_tot_cmi=0;}
								if($res_c_porc_tot_gi==null){$res_c_porc_tot_gi=0;}
								if($res_c_porc_tot_cp==null){$res_c_porc_tot_cp=0;}
								if($res_c_porc_tot_cd==null){$res_c_porc_tot_cd=0;}
								if($res_c_porc_tot_cd_hc==null){$res_c_porc_tot_cd_hc=0;}
								if($res_c_porc_tot_cd_hc_hc==null){$res_c_porc_tot_cd_hc_hc=0;}
								if($res_c_porc_tot_cd_hc_gr==null){$res_c_porc_tot_cd_hc_gr=0;}
								if($res_c_porc_tot_cd_hi==null){$res_c_porc_tot_cd_hi=0;}
								if($res_c_porc_tot_cd_hi_hi==null){$res_c_porc_tot_cd_hi_hi=0;}
								if($res_c_porc_tot_cd_hi_gr==null){$res_c_porc_tot_cd_hi_gr=0;}
								if($res_c_porc_tot_cd_oh==null){$res_c_porc_tot_cd_oh=0;}
								if($res_c_porc_tot_cd_oh_oh==null){$res_c_porc_tot_cd_oh_oh=0;}
								if($res_c_porc_tot_cd_oh_gr==null){$res_c_porc_tot_cd_oh_gr=0;}
								if($res_c_porc_tot_cd_id==null){$res_c_porc_tot_cd_id=0;}
								if($res_c_porc_tot_ct==null){$res_c_porc_tot_ct=0;}
								if($res_c_porc_tot_ct_hg==null){$res_c_porc_tot_ct_hg=0;}
								if($res_c_porc_tot_ct_hg_hg==null){$res_c_porc_tot_ct_hg_hg=0;}
								if($res_c_porc_tot_ct_hg_gr==null){$res_c_porc_tot_ct_hg_gr=0;}
								if($res_c_porc_tot_ct_hv==null){$res_c_porc_tot_ct_hv=0;}
								if($res_c_porc_tot_ct_hv_hv==null){$res_c_porc_tot_ct_hv_hv=0;}
								if($res_c_porc_tot_ct_hv_gr==null){$res_c_porc_tot_ct_hv_gr=0;}
								if($res_c_porc_tot_ct_cp==null){$res_c_porc_tot_ct_cp=0;}
								if($res_c_porc_tot_ct_cp_sv==null){$res_c_porc_tot_ct_cp_sv=0;}
								if($res_c_porc_tot_ct_cp_gp==null){$res_c_porc_tot_ct_cp_gp=0;}
								if($res_c_porc_tot_ct_cp_gs==null){$res_c_porc_tot_ct_cp_gs=0;}
								if($res_c_porc_tot_ct_cp_au==null){$res_c_porc_tot_ct_cp_au=0;}
								if($res_c_porc_tot_ct_cp_cv==null){$res_c_porc_tot_ct_cp_cv=0;}
								if($res_c_porc_tot_ct_gl==null){$res_c_porc_tot_ct_gl=0;}
								if($res_c_porc_tot_ct_gl_hc==null){$res_c_porc_tot_ct_gl_hc=0;}
								if($res_c_porc_tot_ct_gl_nr==null){$res_c_porc_tot_ct_gl_nr=0;}
								if($res_c_porc_tot_ct_gl_ip==null){$res_c_porc_tot_ct_gl_ip=0;}
								if($res_c_porc_tot_ct_gl_ic==null){$res_c_porc_tot_ct_gl_ic=0;}
								if($res_c_porc_tot_ca==null){$res_c_porc_tot_ca=0;}
								if($res_c_porc_tot_ca_vt==null){$res_c_porc_tot_ca_vt=0;}
								if($res_c_porc_tot_ca_vt_pv==null){$res_c_porc_tot_ca_vt_pv=0;}
								if($res_c_porc_tot_ca_vt_op==null){$res_c_porc_tot_ca_vt_op=0;}
								if($res_c_porc_tot_ca_cf==null){$res_c_porc_tot_ca_cf=0;}
								if($res_c_porc_tot_ca_cf_pa==null){$res_c_porc_tot_ca_cf_pa=0;}
								if($res_c_porc_tot_ca_cf_nh==null){$res_c_porc_tot_ca_cf_nh=0;}
								if($res_c_porc_tot_ca_gf==null){$res_c_porc_tot_ca_gf=0;}
								if($res_c_porc_tot_ca_gf_ic==null){$res_c_porc_tot_ca_gf_ic=0;}
								if($res_c_porc_tot_ca_gf_oc==null){$res_c_porc_tot_ca_gf_oc=0;}
								if($res_c_porc_tot_ca_gf_cm==null){$res_c_porc_tot_ca_gf_cm=0;}
								if($res_c_porc_tot_ca_gf_it==null){$res_c_porc_tot_ca_gf_it=0;}
								if($res_c_porc_tot_ca_oc==null){$res_c_porc_tot_ca_oc=0;}
								if($res_c_porc_tot_ca_oc_oc1==null){$res_c_porc_tot_ca_oc_oc1=0;}
								if($res_c_porc_tot_ca_oc_oc2==null){$res_c_porc_tot_ca_oc_oc2=0;}
								if($res_c_porc_tot_ca_oc_oc3==null){$res_c_porc_tot_ca_oc_oc3=0;}
								if($res_c_porc_tot_ca_ri==null){$res_c_porc_tot_ca_ri=0;}
								if($res_c_porc_tot_ci==null){$res_c_porc_tot_ci=0;}
								if($res_c_porc_tot_ci_vb==null){$res_c_porc_tot_ci_vb=0;}
								if($res_c_porc_tot_ci_ov==null){$res_c_porc_tot_ci_ov=0;}
								if($res_c_porc_tot_ci_ov_is==null){$res_c_porc_tot_ci_ov_is=0;}
								if($res_c_porc_tot_ci_ov_im==null){$res_c_porc_tot_ci_ov_im=0;}
								if($res_c_porc_tot_ci_ov_oc==null){$res_c_porc_tot_ci_ov_oc=0;}
								if($res_c_porc_tot_ci_rf==null){$res_c_porc_tot_ci_rf=0;}
								if($res_c_porc_tot_ci_oi==null){$res_c_porc_tot_ci_oi=0;}
								if($res_c_porc_tot_ci_oi_oi1==null){$res_c_porc_tot_ci_oi_oi1=0;}
								if($res_c_porc_tot_ci_oi_oi2==null){$res_c_porc_tot_ci_oi_oi2=0;}
								if($res_c_porc_tot_ci_oi_oi3==null){$res_c_porc_tot_ci_oi_oi3=0;}
								if($res_c_porc_tot_it==null){$res_c_porc_tot_it=0;}
								if($res_c_porc_tot_up==null){$res_c_porc_tot_up=0;}
								if($res_c_porc_tot_up_cc==null){$res_c_porc_tot_up_cc=0;}
								if($res_c_porc_tot_up_ir==null){$res_c_porc_tot_up_ir=0;}
								if($res_c_porc_tot_up2==null){$res_c_porc_tot_up2=0;}
								if($res_c_porc_tot_cv==null){$res_c_porc_tot_cv=0;}
								if($res_c_porc_tot_vt==null){$res_c_porc_tot_vt=0;}
								if($res_c_porc_tot_uc==null){$res_c_porc_tot_uc=0;}
								if($res_c_porc_tot_uc_co==null){$res_c_porc_tot_uc_co=0;}
								if($res_c_porc_tot_uc_ti==null){$res_c_porc_tot_uc_ti=0;}
								if($res_c_porc_tot_uc_pr==null){$res_c_porc_tot_uc_pr=0;}
			//----------------------------------RESUMEN---------------------
			...
			//Insercion de datos
							...
							VALUES ('$res_id',$res_det_etapa,'$res_modelo','$res_fecha',
							$res_total_unidades,
								$res_area_promedio,
								$res_total_area_construida,
								$res_total_area_vendible,
