<!-- 
=======================================================================================================================
==> TITULO DE ARCHIVO: editarServidores.php
...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<br>
	<center>
		<form id="form1" name="form1" method="post" action="editarServidores.php">
			 <table class="tabla">
				  <tr>
	...
	<?php
		...
		$RUTA=$_POST['RUTA_SERV'];
			...
			if($resultado==true){
				...
				print "<script>alert(\"No se ha realizado el cambio, error!\");window.location='editarServidores.php';</script>";
				}
			}
	# cerrar conexion 
	$mysqli->close();
