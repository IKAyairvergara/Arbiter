...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onClick="location.href='../DetalleProyecto/ABT-T019-detalleProyecto-D.php';" style="background-image:url(agregar_03.png); " title="">
	</div>
	...
	<br>
	<br>
	<form id="form1" name="form1" method="post" action="ABT-T003-agregarDetalleProyecto-U.php">
	  <table class="tabla">
	  <tr>
		...
		<?php 
			...
			$DET_PAR_ID=$_POST['DET_PAR_ID']; 		
				if($_POST["DET_ETAPA"]!=""){					
					...
					if($result==false){
							print "<script>alert(\"los datos estan duplicados\");window.location='ABT-T003-agregarDetalleProyecto-U.php';</script>";
							}
							else{
							print "<script>alert(\"los datos se enviaron correctamente\");window.location='../DetalleProyecto/ABT-T019-detalleProyecto-D.php';</script>";
							}
