<!-- 
=======================================================================================================================
==> TITULO DE ARCHIVO: editarCiudades.php
...
function cargar_paises()
{
	$.get("scripts/cargar-paises.php", function(resultado){
		if(resultado == false)
		{
			alert("El País no tiene ciudades registradas");
		}
		else
		{
...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onClick="location.href='../Ciudades/ciudades.php';" style="background-image:url(editar2_08.png); " title="">
	</div>
	...
	<br>
	<center>
	<form id="form1" name="form1" method="post" action="editarCiudades.php">
  <table class="tabla">
			<tr>
...
<?php
	...
	$CIUD_PAISES_EDIT=$_POST['CIUD_PAISES_EDIT'];
					...
					if($result==true){
						print "<script>alert(\"No se ha podido realizar el cambio\");window.location='editarCiudades.php';</script>";
						}
					else{
						print "<script>alert(\"\Cambio realizado con exito\");window.location='../Ciudades/ciudades.php';</script>";
						}
					}
				$mysqli->close();
			?>
