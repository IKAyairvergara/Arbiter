...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onClick="location.href='../Paises/ABT-T041-paises-D.php';" style="background-image:url(eliminar_05.png); " title="">
	</div>
	...
	<br>	
	<center>
	<form method = "post" action = "ABT-T032-eliminarPaises-U.php">
	    ...
	    if(isset($_POST['CIUD_ID'])){
		  ...
		  $result = $mysqli->query($query);
	       if($result==false){
				...
				print "<script>alert(\"Se ha Eliminado correctamente\");window.location='../Paises/ABT-T041-paises-D.php';</script>";
							}
			}
	     }
