<?php
   include "../../php/ABT-T000-conexion-U.php";
	...
	$Example=$_GET['dato']; 
	    ...
	    $consulta = "SELECT DATE_FORMAT(FLC_C_FECHA,'%m/%Y'),
	     DATE_FORMAT(FLC_C_FECHA, '%b/%y'),
		 CASE WHEN (FLC_C_URBANISMO_INTERNO * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_URBANISMO_INTERNO * CONS_UNI_PRE END FLC_C_URBANISMO_INTERNO,
	     CASE WHEN (FLC_C_UI_PRESUPUESTO * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_UI_PRESUPUESTO * CONS_UNI_PRE END FLC_C_UI_PRESUPUESTO,
	     CASE WHEN (FLC_C_UI_INCREMENTOS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_UI_INCREMENTOS * CONS_UNI_PRE END FLC_C_UI_INCREMENTOS,
	     CASE WHEN (FLC_C_COSTOS_MATERIALES_MANO_OBRA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_COSTOS_MATERIALES_MANO_OBRA * CONS_UNI_PRE END FLC_C_COSTOS_MATERIALES_MANO_OBRA,
	     CASE WHEN (FLC_C_CM_PRESUPUESTO * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_CM_PRESUPUESTO * CONS_UNI_PRE END FLC_C_CM_PRESUPUESTO,
	     CASE WHEN (FLC_C_CM_INCREMENTOS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_CM_INCREMENTOS * CONS_UNI_PRE END FLC_C_CM_INCREMENTOS,
	     CASE WHEN (FLC_C_GASTOS_IMPREVISTOS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_GASTOS_IMPREVISTOS * CONS_UNI_PRE END FLC_C_GASTOS_IMPREVISTOS,
	     CASE WHEN (FLC_C_COSTOS_POSTVENTA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_COSTOS_POSTVENTA * CONS_UNI_PRE END FLC_C_COSTOS_POSTVENTA,
	     CASE WHEN (FLC_C_COSTO_DIRECTO_CONSTRUCCION * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_COSTO_DIRECTO_CONSTRUCCION * CONS_UNI_PRE END FLC_C_COSTO_DIRECTO_CONSTRUCCION,
	     CASE WHEN (FLC_C_HONORARIOS_CONSTRUCCION * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_HONORARIOS_CONSTRUCCION * CONS_UNI_PRE END FLC_C_HONORARIOS_CONSTRUCCION,
	     CASE WHEN (FLC_C_HC_HONORARIOS_CONSTRUCCION * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_HC_HONORARIOS_CONSTRUCCION * CONS_UNI_PRE END FLC_C_HC_HONORARIOS_CONSTRUCCION,
	     CASE WHEN (FLC_C_HC_GASTOS_REEMBOLSABLES * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_HC_GASTOS_REEMBOLSABLES * CONS_UNI_PRE END FLC_C_HC_GASTOS_REEMBOLSABLES,
	     CASE WHEN (FLC_C_HONORARIOS_INTERVENTORIA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_HONORARIOS_INTERVENTORIA * CONS_UNI_PRE END FLC_C_HONORARIOS_INTERVENTORIA,
	     CASE WHEN (FLC_C_HI_HONORARIOS_INTERVENTORIA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_HI_HONORARIOS_INTERVENTORIA * CONS_UNI_PRE END FLC_C_HI_HONORARIOS_INTERVENTORIA,
	     CASE WHEN (FLC_C_HI_GASTOS_REEMBOSABLES * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_HI_GASTOS_REEMBOSABLES * CONS_UNI_PRE END FLC_C_HI_GASTOS_REEMBOSABLES,
	     CASE WHEN (FLC_C_OTROS_HONORARIOS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OTROS_HONORARIOS * CONS_UNI_PRE END FLC_C_OTROS_HONORARIOS,
	     CASE WHEN (FLC_C_OH_OTROS_HONORARIOS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OH_OTROS_HONORARIOS * CONS_UNI_PRE END FLC_C_OH_OTROS_HONORARIOS,
	     CASE WHEN (FLC_C_OH_GASTOS_REEMBOLSABLES * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OH_GASTOS_REEMBOLSABLES * CONS_UNI_PRE END FLC_C_OH_GASTOS_REEMBOLSABLES,
	     CASE WHEN (FLC_C_IMPUESTOS_Y_DERECHOS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_IMPUESTOS_Y_DERECHOS * CONS_UNI_PRE END FLC_C_IMPUESTOS_Y_DERECHOS,
	     CASE WHEN (FLC_C_COSTO_TOTAL_CONSTRUCCION * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_COSTO_TOTAL_CONSTRUCCION * CONS_UNI_PRE END FLC_C_COSTO_TOTAL_CONSTRUCCION,
	     CASE WHEN (FLC_C_HONORARIOS_GERENCIA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_HONORARIOS_GERENCIA * CONS_UNI_PRE END FLC_C_HONORARIOS_GERENCIA,
	     CASE WHEN (FLC_C_HG_HONORARIOS_GERENCIA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_HG_HONORARIOS_GERENCIA * CONS_UNI_PRE END FLC_C_HG_HONORARIOS_GERENCIA,
	     CASE WHEN (FLC_C_HG_GASTOS_REEMBOLSABLES * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_HG_GASTOS_REEMBOLSABLES * CONS_UNI_PRE END FLC_C_HG_GASTOS_REEMBOLSABLES,
	     CASE WHEN (FLC_C_HONORARIOS_VENTAS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_HONORARIOS_VENTAS * CONS_UNI_PRE END FLC_C_HONORARIOS_VENTAS,
	     CASE WHEN (FLC_C_HV_HONORARIOS_VENTAS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_HV_HONORARIOS_VENTAS * CONS_UNI_PRE END FLC_C_HV_HONORARIOS_VENTAS,
	     CASE WHEN (FLC_C_HV_GASTOS_REEMBOLSABLES * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_HV_GASTOS_REEMBOLSABLES * CONS_UNI_PRE END FLC_C_HV_GASTOS_REEMBOLSABLES,
	     CASE WHEN (FLC_C_COSTOS_PROMOCION_Y_VENTAS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_COSTOS_PROMOCION_Y_VENTAS * CONS_UNI_PRE END FLC_C_COSTOS_PROMOCION_Y_VENTAS,
	     CASE WHEN (FLC_C_CP_SALA_DE_VENTAS_UNIDADES_MODELO * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_CP_SALA_DE_VENTAS_UNIDADES_MODELO * CONS_UNI_PRE END FLC_C_CP_SALA_DE_VENTAS_UNIDADES_MODELO,
	     CASE WHEN (FLC_C_CP_GASTOS_PUBLICIDAD * CONS_UNI_PRE)= 0 THEN '' ELSE FLC_C_CP_GASTOS_PUBLICIDAD * CONS_UNI_PRE END FLC_C_CP_GASTOS_PUBLICIDAD,
	     CASE WHEN (FLC_C_CP_GASTOS_SALA_DE_VENTAS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_CP_GASTOS_SALA_DE_VENTAS * CONS_UNI_PRE END FLC_C_CP_GASTOS_SALA_DE_VENTAS,
	     CASE WHEN (FLC_C_CP_ADMINISTRACION_UNIDADES_POR_ENTREGAR * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_CP_ADMINISTRACION_UNIDADES_POR_ENTREGAR * CONS_UNI_PRE END FLC_C_CP_ADMINISTRACION_UNIDADES_POR_ENTREGAR,
	     CASE WHEN (FLC_C_CP_COMISIONES_VENTAS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_CP_COMISIONES_VENTAS * CONS_UNI_PRE END FLC_C_CP_COMISIONES_VENTAS,
	     CASE WHEN (FLC_C_GASTOS_LEGALES * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_GASTOS_LEGALES * CONS_UNI_PRE END FLC_C_GASTOS_LEGALES,
	     CASE WHEN (FLC_C_GL_HIPOTECAS_CREDITO_CONSTRUCTOR * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_GL_HIPOTECAS_CREDITO_CONSTRUCTOR * CONS_UNI_PRE END FLC_C_GL_HIPOTECAS_CREDITO_CONSTRUCTOR,
	     CASE WHEN (FLC_C_GL_NOTARIALES_REGISTRO_DE_VENTAS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_GL_NOTARIALES_REGISTRO_DE_VENTAS * CONS_UNI_PRE END FLC_C_GL_NOTARIALES_REGISTRO_DE_VENTAS,
	     CASE WHEN (FLC_C_GL_IMPUESTO_PREDIAL_INMUEBLES_POR_ESCRITURA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_GL_IMPUESTO_PREDIAL_INMUEBLES_POR_ESCRITURA * CONS_UNI_PRE END FLC_C_GL_IMPUESTO_PREDIAL_INMUEBLES_POR_ESCRITURA,
	     CASE WHEN (FLC_C_GL_IMPUESTO_ICA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_GL_IMPUESTO_ICA * CONS_UNI_PRE END FLC_C_GL_IMPUESTO_ICA,
	     CASE WHEN (FLC_C_COSTO_TOTAL_ANTES_TERRENO_Y_FINANCIEROS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_COSTO_TOTAL_ANTES_TERRENO_Y_FINANCIEROS * CONS_UNI_PRE END FLC_C_COSTO_TOTAL_ANTES_TERRENO_Y_FINANCIEROS,
	     CASE WHEN (FLC_C_VALOR_TERRENO_URBANIZADO * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_VALOR_TERRENO_URBANIZADO * CONS_UNI_PRE END FLC_C_VALOR_TERRENO_URBANIZADO,
	     CASE WHEN (FLC_C_VT_VALOR_ADQUISICION * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_VT_VALOR_ADQUISICION * CONS_UNI_PRE END FLC_C_VT_VALOR_ADQUISICION,
	     CASE WHEN (FLC_C_VT_COSTOS_URBANISMO_Y_OTROS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_VT_COSTOS_URBANISMO_Y_OTROS * CONS_UNI_PRE END FLC_C_VT_COSTOS_URBANISMO_Y_OTROS,
	     CASE WHEN (FLC_C_COMISIONES_FIDUCIA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_COMISIONES_FIDUCIA * CONS_UNI_PRE END FLC_C_COMISIONES_FIDUCIA,
	     CASE WHEN (FLC_C_CF_PREVENTAS_Y_ADMINISTRACION * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_CF_PREVENTAS_Y_ADMINISTRACION * CONS_UNI_PRE END FLC_C_CF_PREVENTAS_Y_ADMINISTRACION,
	     CASE WHEN (FLC_C_CF_NUEVOGAR * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_CF_NUEVOGAR * CONS_UNI_PRE END FLC_C_CF_NUEVOGAR,
	     CASE WHEN (FLC_C_GASTOS_FINANCIEROS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_GASTOS_FINANCIEROS * CONS_UNI_PRE END FLC_C_GASTOS_FINANCIEROS,
	     CASE WHEN (FLC_C_GF_INTERESES_CREDITOS_CONSTRUCTOR * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_GF_INTERESES_CREDITOS_CONSTRUCTOR * CONS_UNI_PRE END FLC_C_GF_INTERESES_CREDITOS_CONSTRUCTOR,
	     CASE WHEN (FLC_C_GF_OTROS_COSTOS_CREDITO * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_GF_OTROS_COSTOS_CREDITO * CONS_UNI_PRE END FLC_C_GF_OTROS_COSTOS_CREDITO,
	     CASE WHEN (FLC_C_GF_CORRECCION_MONETARIA_CONSTRUCCION * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_GF_CORRECCION_MONETARIA_CONSTRUCCION * CONS_UNI_PRE END FLC_C_GF_CORRECCION_MONETARIA_CONSTRUCCION,
	     CASE WHEN (FLC_C_GF_IMPUESTO_TRANSACCIONES_FINANCIERAS_ITF * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_GF_IMPUESTO_TRANSACCIONES_FINANCIERAS_ITF * CONS_UNI_PRE END FLC_C_GF_IMPUESTO_TRANSACCIONES_FINANCIERAS_ITF,
	     CASE WHEN (FLC_C_OTROS_COSTOS_Y_GASTOS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OTROS_COSTOS_Y_GASTOS * CONS_UNI_PRE END FLC_C_OTROS_COSTOS_Y_GASTOS,
	     CASE WHEN (FLC_C_OC_COSTOS_GASTOS1 * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OC_COSTOS_GASTOS1 * CONS_UNI_PRE END FLC_C_OC_COSTOS_GASTOS1,
	     CASE WHEN (FLC_C_OC_COSTOS_GASTOS2 * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OC_COSTOS_GASTOS2 * CONS_UNI_PRE END FLC_C_OC_COSTOS_GASTOS2,
	     CASE WHEN (FLC_C_OC_COSTOS_GASTOS3 * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OC_COSTOS_GASTOS3 * CONS_UNI_PRE END FLC_C_OC_COSTOS_GASTOS3,
	     CASE WHEN (FLC_C_REINTEGROS_IVA_PROYECTOS_VIS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_REINTEGROS_IVA_PROYECTOS_VIS * CONS_UNI_PRE END FLC_C_REINTEGROS_IVA_PROYECTOS_VIS,
	     CASE WHEN (FLC_C_COSTO_TOTAL_DIRECTOS_E_INDIRECTOS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_COSTO_TOTAL_DIRECTOS_E_INDIRECTOS * CONS_UNI_PRE END FLC_C_COSTO_TOTAL_DIRECTOS_E_INDIRECTOS,
	     CASE WHEN (FLC_C_TOTAL_EGRESOS_SIN_CORRECCION_MONETARIA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_TOTAL_EGRESOS_SIN_CORRECCION_MONETARIA * CONS_UNI_PRE END FLC_C_TOTAL_EGRESOS_SIN_CORRECCION_MONETARIA,
	     CASE WHEN (FLC_C_DESEMBOLSOS_CREDITOS_CONSTRUCTOR_Y_TERRENO * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_DESEMBOLSOS_CREDITOS_CONSTRUCTOR_Y_TERRENO * CONS_UNI_PRE END FLC_C_DESEMBOLSOS_CREDITOS_CONSTRUCTOR_Y_TERRENO,
	     CASE WHEN (FLC_C_ABONOS_EXTRAORDINARIOS_CREDITOS_CONSTRUCTOR_Y_TERRENO * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_ABONOS_EXTRAORDINARIOS_CREDITOS_CONSTRUCTOR_Y_TERRENO * CONS_UNI_PRE END FLC_C_ABONOS_EXTRAORDINARIOS_CREDITOS_CONSTRUCTOR_Y_TERRENO,
	     CASE WHEN (FLC_C_INGRESOS_POR_VENTAS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_INGRESOS_POR_VENTAS * CONS_UNI_PRE END FLC_C_INGRESOS_POR_VENTAS,
	     CASE WHEN (FLC_C_IV_ABONOS_SEPARACION * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_IV_ABONOS_SEPARACION * CONS_UNI_PRE END FLC_C_IV_ABONOS_SEPARACION,
	     CASE WHEN (FLC_C_IV_CARTERA_CUOTA_INICIAL * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_IV_CARTERA_CUOTA_INICIAL * CONS_UNI_PRE END FLC_C_IV_CARTERA_CUOTA_INICIAL,
	     CASE WHEN (FLC_C_IV_SALDO_CUOTA_INICIAL_Y_ABONO_ESCRITURA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_IV_SALDO_CUOTA_INICIAL_Y_ABONO_ESCRITURA * CONS_UNI_PRE END FLC_C_IV_SALDO_CUOTA_INICIAL_Y_ABONO_ESCRITURA,
	     CASE WHEN (FLC_C_IV_SUBSIDIO_VIS_Y_AHORRO_PROGRAMADO * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_IV_SUBSIDIO_VIS_Y_AHORRO_PROGRAMADO * CONS_UNI_PRE END FLC_C_IV_SUBSIDIO_VIS_Y_AHORRO_PROGRAMADO,
	     CASE WHEN (FLC_C_IV_EXCEDENTES_CREDITO_COMPRADORES * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_IV_EXCEDENTES_CREDITO_COMPRADORES * CONS_UNI_PRE END FLC_C_IV_EXCEDENTES_CREDITO_COMPRADORES,
	     CASE WHEN (FLC_C_IV_GIROS_DIRECTOS_CREDITOS_OTRAS_ENTIDADES * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_IV_GIROS_DIRECTOS_CREDITOS_OTRAS_ENTIDADES * CONS_UNI_PRE END FLC_C_IV_GIROS_DIRECTOS_CREDITOS_OTRAS_ENTIDADES,
	     CASE WHEN (FLC_C_IV_INGRESOS_POR_RECIBIR_VENTAS_REALIZADAS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_IV_INGRESOS_POR_RECIBIR_VENTAS_REALIZADAS * CONS_UNI_PRE END FLC_C_IV_INGRESOS_POR_RECIBIR_VENTAS_REALIZADAS,
	     CASE WHEN (FLC_C_OTROS_INGRESOS_VENTAS_INTERESES * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OTROS_INGRESOS_VENTAS_INTERESES * CONS_UNI_PRE END FLC_C_OTROS_INGRESOS_VENTAS_INTERESES,
	     CASE WHEN (FLC_C_OI_INTERESES_SUBROGACION * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OI_INTERESES_SUBROGACION * CONS_UNI_PRE END FLC_C_OI_INTERESES_SUBROGACION,
	     CASE WHEN (FLC_C_OI_INTERESES_MORA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OI_INTERESES_MORA * CONS_UNI_PRE END FLC_C_OI_INTERESES_MORA,
	     CASE WHEN (FLC_C_OI_OFERTAS_COMERCIALES_OTROS_INGRESOS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OI_OFERTAS_COMERCIALES_OTROS_INGRESOS * CONS_UNI_PRE END FLC_C_OI_OFERTAS_COMERCIALES_OTROS_INGRESOS,
	     CASE WHEN (FLC_C_RENDIMIENTOS_FIDEICOMISO * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_RENDIMIENTOS_FIDEICOMISO * CONS_UNI_PRE END FLC_C_RENDIMIENTOS_FIDEICOMISO,
	     CASE WHEN (FLC_C_OTROS_INGRESOS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OTROS_INGRESOS * CONS_UNI_PRE END FLC_C_OTROS_INGRESOS,
	     CASE WHEN (FLC_C_OI_INGRESOS1 * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OI_INGRESOS1 * CONS_UNI_PRE END FLC_C_OI_INGRESOS1,
	     CASE WHEN (FLC_C_OI_INGRESOS2 * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OI_INGRESOS2 * CONS_UNI_PRE END FLC_C_OI_INGRESOS2,
	     CASE WHEN (FLC_C_OI_INGRESOS3 * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_OI_INGRESOS3 * CONS_UNI_PRE END FLC_C_OI_INGRESOS3,
	     CASE WHEN (FLC_C_INGRESOS_TOTALES * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_INGRESOS_TOTALES * CONS_UNI_PRE END FLC_C_INGRESOS_TOTALES,
	     CASE WHEN (FLC_C_FLUJO_NETO_CAJA_CT * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_FLUJO_NETO_CAJA_CT * CONS_UNI_PRE END FLC_C_FLUJO_NETO_CAJA_CT,
	     CASE WHEN (FLC_C_FLUJO_ACUMULADO_CAJA_CT * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_FLUJO_ACUMULADO_CAJA_CT * CONS_UNI_PRE END FLC_C_FLUJO_ACUMULADO_CAJA_CT,
	     CASE WHEN (FLC_C_COSTO_CREDITOS_TESORERIA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_COSTO_CREDITOS_TESORERIA * CONS_UNI_PRE END FLC_C_COSTO_CREDITOS_TESORERIA,
	     CASE WHEN (FLC_C_IMPUESTO_DE_RENTA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_IMPUESTO_DE_RENTA * CONS_UNI_PRE END FLC_C_IMPUESTO_DE_RENTA,
	     CASE WHEN (FLC_C_FLUJO_NETO_CAJA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_FLUJO_NETO_CAJA * CONS_UNI_PRE END FLC_C_FLUJO_NETO_CAJA,
	     CASE WHEN (FLC_C_FLUJO_ACUMULADO_CAJA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_FLUJO_ACUMULADO_CAJA * CONS_UNI_PRE END FLC_C_FLUJO_ACUMULADO_CAJA,
	     CASE WHEN (FLC_C_PROYECCION_VENTAS_UNIDADES * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_PROYECCION_VENTAS_UNIDADES * CONS_UNI_PRE END FLC_C_PROYECCION_VENTAS_UNIDADES,
	     CASE WHEN (FLC_C_VENTAS_BRUTAS * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_VENTAS_BRUTAS * CONS_UNI_PRE END FLC_C_VENTAS_BRUTAS,
	     CASE WHEN (FLC_C_PRECIO_PROMEDIO * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_PRECIO_PROMEDIO * CONS_UNI_PRE END FLC_C_PRECIO_PROMEDIO,
	     CASE WHEN (FLC_C_PROYECCION_ENTREGAS_UNIDADES * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_PROYECCION_ENTREGAS_UNIDADES * CONS_UNI_PRE END FLC_C_PROYECCION_ENTREGAS_UNIDADES,
	     CASE WHEN (FLC_C_PROYECCION_ESCRITURAS_VALOR * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_PROYECCION_ESCRITURAS_VALOR * CONS_UNI_PRE END FLC_C_PROYECCION_ESCRITURAS_VALOR,
	     CASE WHEN (FLC_C_PROYECCION_ESCRITURAS_UNIDADES * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_PROYECCION_ESCRITURAS_UNIDADES * CONS_UNI_PRE END FLC_C_PROYECCION_ESCRITURAS_UNIDADES,
	     CASE WHEN (FLC_C_PROYECCION_SUBROGACIONES_VALOR * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_PROYECCION_SUBROGACIONES_VALOR * CONS_UNI_PRE END FLC_C_PROYECCION_SUBROGACIONES_VALOR,
	     CASE WHEN (FLC_C_VPN * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_VPN * CONS_UNI_PRE END FLC_C_VPN,
	     CASE WHEN (FLC_C_TIR_EA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_TIR_EA * CONS_UNI_PRE END FLC_C_TIR_EA,
	     CASE WHEN (FLC_C_TIR_EM * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_TIR_EM * CONS_UNI_PRE END FLC_C_TIR_EM,
	     CASE WHEN (FLC_C_TIR_MOD_EA * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_TIR_MOD_EA * CONS_UNI_PRE END FLC_C_TIR_MOD_EA,
	     CASE WHEN (FLC_C_C_TIR_MOD_EM * CONS_UNI_PRE) = 0 THEN '' ELSE FLC_C_C_TIR_MOD_EM * CONS_UNI_PRE END FLC_C_C_TIR_MOD_EM
...
$moneda=1;					 
		...
		while ($fila = $resultado->fetch_array()) {
			$objPHPExcel->setActiveSheetIndex(0) 
					 ->setCellValue($columnas[$c].'2',  '1/'.$fila["DATE_FORMAT(FLC_C_FECHA,'%m/%Y')"])
