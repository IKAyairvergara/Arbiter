<?php
		...
		if($envio=="Flujo Caja Terreno"){
			header('Location: ABT-T052-flujoCajaTerrenoExcel-D.php?dato='.$variable);
		}
		if($envio=="Flujo Caja"){
			header('Location: ABT-T050-flujoCajaExcel-D.php?dato='.$variable);
		}
		if($envio=="Otros Flujos"){
			$_SESSION['VAR']=$variable;
			header('Location: ABT-T057-otrosFlujos-D.php?dato='.$variable);
...
<div style="position:absolute; left:10%; top:0px; width:1025px; height:769px;">
	...
	<div id="p4" onclick="location.href='../InformesMain/ABT-T040-informesMain.php';"  style="background-image:url(informes_03.png);" title="">
	</div>
	<div style="background-image:url(informes_04.png); position:absolute; left:794px; top:27px; width:24px; height:208px;" title="">
	</div>
	<div id="p5" onclick="location.href='../Bienvenido/ABT-T010-bienvenido.php';" style="background-image:url(informes_05.png);" title="">
	</div>
