...
CASE WHEN RES_C_INCREMENTOS2 = 0 THEN '' ELSE ((RES_C_INCREMENTOS2 * CONS_UNI_PRE)/CONS_IND_VALOR_REE) END RES_C_INCREMENTOS2,CASE WHEN RES_C_GASTOS_IMPREVISTOS = 0 THEN '' ELSE ((RES_C_GASTOS_IMPREVISTOS * CONS_UNI_PRE)/CONS_IND_VALOR_REE) END RES_C_GASTOS_IMPREVISTOS,
