...
<div style="position:absolute; left:10%; top:0px; width:1025px; height:769px;">
	...
	<div id="p" onclick="location.href='../Informes/informesExcel.php';" style="background-image:url(informes_15.png);" title="" >
	</div>
	<div style="background-image:url(informes_16.png); position:absolute; left:490px; top:515px; width:28px; height:254px;" title="">
	</div>
	<div id="p1" onclick="location.href='../Informes/informesPDF.php';"  style="background-image:url(informes_17.png);" title="">
	</div>
