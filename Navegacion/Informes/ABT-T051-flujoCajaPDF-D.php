...
$resultado1 = $conexion->query($consulta_flujo_caja);
if($resultado->num_rows > 0){
	...
	$objPHPExcel->getProperties()
				...
				while ($fila = $resultado->fetch_array()) {
					...
					->setCellValue('C80', '=B80/'.$ven_bru)
					->setCellValue('C81', '=B81/'.$ven_bru)
					->setCellValue('C82', '=B82/'.$ven_bru)
					->setCellValue('C83', '=B83/'.$ven_bru)
					->setCellValue('C84', '=B84/'.$ven_bru)
					->setCellValue('C85', '=B85/'.$ven_bru)
					->setCellValue('C86', '=B86/'.$ven_bru)
					->setCellValue('C91', '=B91/'.$ven_bru)
					->setCellValue('C92', '=B92/'.$ven_bru)
					->setCellValue('C93', '=B93/'.$ven_bru)
					->setCellValue('C94', '=B94/'.$ven_bru)
					->setCellValue('C95', '=B95/'.$ven_bru)
				...
				//	->setCellValue('C89', '=(XIRR(E85:XFD85,E2:XFD2))')
					...
					->setCellValue('E89', '=MIRR(E85:XFD85,'.$fila['CONS_IND_VALOR_REE'].'%,0)')
		...
		*/					
							$objPHPExcel->getActiveSheet()->getStyle('B5:B97')
							 ->getNumberFormat()->setFormatCode('#,##0');
							  $objPHPExcel->getActiveSheet()->getStyle('E2:L2')->getFont()->getColor()->setARGB(PHPExcel_Style_Color::COLOR_WHITE);
