<?php
	...
	$Example=$_GET['dato']; 
	   ...
	   $consulta = "SELECT
		...
		CASE WHEN FCT_C_VAP_ABONOS_PACTADOS_POR_VENTAS  = 0 THEN '' ELSE FCT_C_VAP_ABONOS_PACTADOS_POR_VENTAS END FCT_C_VAP_ABONOS_PACTADOS_POR_VENTAS,
		CASE WHEN FCT_C_COSTOS_URBANISMO  = 0 THEN '' ELSE FCT_C_COSTOS_URBANISMO END FCT_C_COSTOS_URBANISMO,
		CASE WHEN FCT_C_CU_PRESUPUESTO  = 0 THEN '' ELSE FCT_C_CU_PRESUPUESTO END FCT_C_CU_PRESUPUESTO,
		CASE WHEN FCT_C_CU_INCREMENTOS  = 0 THEN '' ELSE FCT_C_CU_INCREMENTOS END FCT_C_CU_INCREMENTOS,
		CASE WHEN FCT_C_COSTOS_INFRAESTRUCTURA  = 0 THEN '' ELSE FCT_C_COSTOS_INFRAESTRUCTURA END FCT_C_COSTOS_INFRAESTRUCTURA,
		CASE WHEN FCT_C_CI_PRESUPUESTO  = 0 THEN '' ELSE FCT_C_CI_PRESUPUESTO END FCT_C_CI_PRESUPUESTO,
		CASE WHEN FCT_C_CI_INCREMENTOS  = 0 THEN '' ELSE FCT_C_CI_INCREMENTOS END FCT_C_CI_INCREMENTOS,
		CASE WHEN FCT_C_CI_RECUPERACION_COSTOS  = 0 THEN '' ELSE FCT_C_CI_RECUPERACION_COSTOS END FCT_C_CI_RECUPERACION_COSTOS,
		CASE WHEN FCT_C_GASTOS_IMPREVISTOS  = 0 THEN '' ELSE FCT_C_GASTOS_IMPREVISTOS END FCT_C_GASTOS_IMPREVISTOS,
		CASE WHEN FCT_C_COSTO_DIRECTO_URBANISMO  = 0 THEN '' ELSE FCT_C_COSTO_DIRECTO_URBANISMO END FCT_C_COSTO_DIRECTO_URBANISMO,
		CASE WHEN FCT_C_HONORARIOS_CONSTRUCCION  = 0 THEN '' ELSE FCT_C_HONORARIOS_CONSTRUCCION END FCT_C_HONORARIOS_CONSTRUCCION,
		CASE WHEN FCT_C_HONORARIOS_INTERVENTORIA  = 0 THEN '' ELSE FCT_C_HONORARIOS_INTERVENTORIA END FCT_C_HONORARIOS_INTERVENTORIA,
		CASE WHEN FCT_C_OTROS_HONORARIOS_TERCEROS  = 0 THEN '' ELSE FCT_C_OTROS_HONORARIOS_TERCEROS END FCT_C_OTROS_HONORARIOS_TERCEROS,
		CASE WHEN FCT_C_LICENCIA_URBANISMO_OTROS_COSTOS  = 0 THEN '' ELSE FCT_C_LICENCIA_URBANISMO_OTROS_COSTOS END FCT_C_LICENCIA_URBANISMO_OTROS_COSTOS,
		CASE WHEN FCT_C_GASTOS_LEGALES  = 0 THEN '' ELSE FCT_C_GASTOS_LEGALES END FCT_C_GASTOS_LEGALES,
		CASE WHEN FCT_C_GL_HIPOTECA_CREDITO_COMPRA_TERRENO  = 0 THEN '' ELSE FCT_C_GL_HIPOTECA_CREDITO_COMPRA_TERRENO END FCT_C_GL_HIPOTECA_CREDITO_COMPRA_TERRENO,
		CASE WHEN FCT_C_GL_GASTOS_NOTARIALES_REGISTRO_COMPRA_TERRENO  = 0 THEN '' ELSE FCT_C_GL_GASTOS_NOTARIALES_REGISTRO_COMPRA_TERRENO END FCT_C_GL_GASTOS_NOTARIALES_REGISTRO_COMPRA_TERRENO,
		CASE WHEN FCT_C_GL_IMPUESTO_PREDIAL  = 0 THEN '' ELSE FCT_C_GL_IMPUESTO_PREDIAL END FCT_C_GL_IMPUESTO_PREDIAL,
		CASE WHEN FCT_C_GASTOS_FINANCIEROS  = 0 THEN '' ELSE FCT_C_GASTOS_FINANCIEROS END FCT_C_GASTOS_FINANCIEROS,
		CASE WHEN FCT_C_GF_INTERESES_CREDITO_TERRENO  = 0 THEN '' ELSE FCT_C_GF_INTERESES_CREDITO_TERRENO END FCT_C_GF_INTERESES_CREDITO_TERRENO,
		CASE WHEN FCT_C_GF_CORRECION_MONETARIA  = 0 THEN '' ELSE FCT_C_GF_CORRECION_MONETARIA END FCT_C_GF_CORRECION_MONETARIA,
		CASE WHEN FCT_C_GF_OTROS_COSTOS_CREDITO_TERRENO  = 0 THEN '' ELSE FCT_C_GF_OTROS_COSTOS_CREDITO_TERRENO END FCT_C_GF_OTROS_COSTOS_CREDITO_TERRENO,
		CASE WHEN FCT_C_GF_IMPUESTO_TRANSACCIONES_FINANCIERAS  = 0 THEN '' ELSE FCT_C_GF_IMPUESTO_TRANSACCIONES_FINANCIERAS END FCT_C_GF_IMPUESTO_TRANSACCIONES_FINANCIERAS,
		CASE WHEN FCT_C_OTROS_COSTOS  = 0 THEN '' ELSE FCT_C_OTROS_COSTOS END FCT_C_OTROS_COSTOS,
		CASE WHEN FCT_C_OC_COSTOS1  = 0 THEN '' ELSE FCT_C_OC_COSTOS1 END FCT_C_OC_COSTOS1,
		CASE WHEN FCT_C_OC_COSTOS2  = 0 THEN '' ELSE FCT_C_OC_COSTOS2 END FCT_C_OC_COSTOS2,
		CASE WHEN FCT_C_VALOR_TERRENO_URBANIZADO  = 0 THEN '' ELSE FCT_C_VALOR_TERRENO_URBANIZADO END FCT_C_VALOR_TERRENO_URBANIZADO,
		CASE WHEN FCT_C_OTROS_GASTOS  = 0 THEN '' ELSE FCT_C_OTROS_GASTOS END FCT_C_OTROS_GASTOS,
		CASE WHEN FCT_C_OG_OTROS_GASTOS1  = 0 THEN '' ELSE FCT_C_OG_OTROS_GASTOS1 END FCT_C_OG_OTROS_GASTOS1,
		CASE WHEN FCT_C_OG_OTROS_GASTOS2  = 0 THEN '' ELSE FCT_C_OG_OTROS_GASTOS2 END FCT_C_OG_OTROS_GASTOS2,
		CASE WHEN FCT_C_VALOR_TOTAL_TERRENO  = 0 THEN '' ELSE FCT_C_VALOR_TOTAL_TERRENO END FCT_C_VALOR_TOTAL_TERRENO,
		CASE WHEN FCT_C_TOTAL_EGRESOS_SIN_CORRECCION_MONETARIA  = 0 THEN '' ELSE FCT_C_TOTAL_EGRESOS_SIN_CORRECCION_MONETARIA END FCT_C_TOTAL_EGRESOS_SIN_CORRECCION_MONETARIA,
		CASE WHEN FCT_C_DESEMBOLSOS_CREDITO_TERRENO  = 0 THEN '' ELSE FCT_C_DESEMBOLSOS_CREDITO_TERRENO END FCT_C_DESEMBOLSOS_CREDITO_TERRENO,
		CASE WHEN FCT_C_ABONOS_AL_CREDITO  = 0 THEN '' ELSE FCT_C_ABONOS_AL_CREDITO END FCT_C_ABONOS_AL_CREDITO,
		CASE WHEN FCT_C_AAL_ABONOS_PROGRAMADOS_CREDITO_TERRENO  = 0 THEN '' ELSE FCT_C_AAL_ABONOS_PROGRAMADOS_CREDITO_TERRENO END FCT_C_AAL_ABONOS_PROGRAMADOS_CREDITO_TERRENO,
		CASE WHEN FCT_C_AAL_ABONOS_DISPONIBILIDAD_CAJA_Y_CANCELACION  = 0 THEN '' ELSE FCT_C_AAL_ABONOS_DISPONIBILIDAD_CAJA_Y_CANCELACION END FCT_C_AAL_ABONOS_DISPONIBILIDAD_CAJA_Y_CANCELACION,
		CASE WHEN FCT_C_OTROS_INGRESOS  = 0 THEN '' ELSE FCT_C_OTROS_INGRESOS END FCT_C_OTROS_INGRESOS,
		CASE WHEN FCT_C_OI_OTROS_INGRESOS1  = 0 THEN '' ELSE FCT_C_OI_OTROS_INGRESOS1 END FCT_C_OI_OTROS_INGRESOS1,
		CASE WHEN FCT_C_OI_OTROS_INGRESOS2  = 0 THEN '' ELSE FCT_C_OI_OTROS_INGRESOS2 END FCT_C_OI_OTROS_INGRESOS2,
		CASE WHEN FCT_C_TRASLADO_TERRENO_A_SUBPROYECTOS  = 0 THEN '' ELSE FCT_C_TRASLADO_TERRENO_A_SUBPROYECTOS END FCT_C_TRASLADO_TERRENO_A_SUBPROYECTOS,
		CASE WHEN FCT_C_TOTAL_INGRESOS  = 0 THEN '' ELSE FCT_C_TOTAL_INGRESOS END FCT_C_TOTAL_INGRESOS,
		CASE WHEN FCT_C_FLUJO_NETO_CAJA  = 0 THEN '' ELSE FCT_C_FLUJO_NETO_CAJA END FCT_C_FLUJO_NETO_CAJA,
		CASE WHEN FCT_C_FLUJO_ACUMULADO  = 0 THEN '' ELSE FCT_C_FLUJO_ACUMULADO END FCT_C_FLUJO_ACUMULADO,
		CASE WHEN FCT_C_VPN  = 0 THEN '' ELSE FCT_C_VPN END FCT_C_VPN,
		CASE WHEN FCT_C_TIR_EA  = 0 THEN '' ELSE FCT_C_TIR_EA END FCT_C_TIR_EA,
		CASE WHEN FCT_C_TIR_EM  = 0 THEN '' ELSE FCT_C_TIR_EM END FCT_C_TIR_EM,
