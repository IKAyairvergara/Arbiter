...
<style type="text/css">
	...
	#p{position:absolute; left:242px; top:291px; width:546px; height:89px; background-image:url(carga-manual_14.png);}
	#p:hover
	{
		opacity: 1.0;
	...
	input[type=submit]{
		...
		width:423px; 
		height:49px;
		background-image: url(carga-manual_14.png);
		opacity: 1.0 ;
	}
...
input[type=file]{
		...
		width:546px; 
		height:89px;
		background-image: url(carga-manual_10.png);
		color: transparent;
		opacity: 0;
		}
		...
		if(isset($_POST['radio'])){
			...
			//----------------------------------RESUMEN---------------------
						...
						$envio_Tb_Otros_Flujos="INSERT INTO tb_otros_flujos (OFL_DET_PRO_ID, OFL_DET_ETAPA, OFL_MODELO, OFL_FECHA, OFL_COSTO_CONSTRUCCION, OFL_HONORARIOS_COLPATRIA, OFL_GASTOS_OPERACION_COLPATRIA, 
							...
							if(!$resultado_ofl= $mysqli -> query($envio_Tb_modelos)){
									echo(' ');
								}	
							print "<script>alert(\"Datos Insertados Correctamente\");</script>";
