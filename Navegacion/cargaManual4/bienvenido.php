...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p" onclick="location.href='http://modelo-c.ditscol.com';"  style="background-image:url(bienvenido_03.png); cursor:pointer;" title="">
	</div>
	...
	<div id="p2" onclick="location.href='../Seleccion2/seleccion.html';" style="background-image:url(bienvenido_07.png); cursor:pointer;" title="">
	</div>
	<div style="background-image:url(bienvenido_08.png); position:absolute; left:623px; top:147px; width:129px; height:621px;" title="">
	</div>
	<div id="p3" onclick="location.href='../cargaManual4/cargaManual.html';" style="background-image:url(bienvenido_09.png); cursor:pointer;" title="">
	</div>
	...
	<div id="p1" onclick="location.href='../Parametrizacion/parametrizacion.php';" style="background-image:url(bienvenido_12.png); cursor:pointer;" title="">
	</div>
	...
	<div id="p6" onclick="location.href='../Informes/informes.php';" style="background-image:url(bienvenido_17.png); cursor:pointer;" title="">
	</div>
	...
	<div id="p4" onclick="location.href='../Depuracion/depuracion.php';" style="background-image:url(bienvenido_20.png); cursor:pointer;" title="">
	</div>
