...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onclick="location.href='../Parametrizacion/ABT-T042-parametrizacion-D.php';" style="background-image:url(detalleProyecto_03.png); cursor:pointer;" title="">
	</div>
	...
	<div id="p" onclick="location.href='../Bienvenido/ABT-T010-bienvenido.php';" style="background-image:url(detalleProyecto_05.png); cursor:pointer;" title="">
	</div>
...
left join tb_participacion d on d.par_id=a.det_par_id";
	...
	<div id="p2" onclick="location.href='../EditarDetalleProyecto/ABT-T021-editarDetalleProyecto-U.php';" style="background-image:url(detalleProyecto_14.png)" title="">
	</div>
	...
	<div id="p3" onclick="location.href='../AgregarDetalleProyecto/ABT-T003-agregarDetalleProyecto-U.php';" style="background-image:url(detalleProyecto_16.png);" title="">
	</div>
	...
	<div id="p4" onclick="location.href='../EliminarDetalleProyecto/ABT-T030-eliminarDetalleProyecto-U.php';" style="background-image:url(detalleProyecto_19.png);" title="">
	</div>
