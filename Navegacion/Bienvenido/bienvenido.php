<!-- 
=======================================================================================================================
==> TITULO DE ARCHIVO: bienvenido.php

==> DESCRIPCION: Pantalla de menú principal
...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p2" onclick="location.href='../Seleccion2/seleccion.php';" style="background-image:url(bienvenido_07.png); cursor:pointer;" title="">
	</div>
	<div style="background-image:url(bienvenido_08.png); position:absolute; left:623px; top:147px; width:129px; height:621px;" title="">
	</div>
	<div id="p3" onclick="location.href='../Carga/carga.php';" style="background-image:url(bienvenido_09.png); cursor:pointer;" title="">
	</div>
