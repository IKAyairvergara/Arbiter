...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onClick="location.href='../Paises/ABT-T041-paises-D.php';" style="background-image:url(editar2_08.png); " title="">
	</div>
    ...
    <br>
    <center>
	<form id="form1" name="form1" method="post" action="ABT-T023-editarPaises-U.php">
  <table class="tabla">
  <tr>
...
<?php
			include "../../php/ABT-T000-conexion-U.php";			
				...
				$PAIS_ID= $_POST['PAIS_ID'];
					...
					if($resultado){
						print "<script>alert(\"\Cambio realizado con exito\");window.location='../Paises/ABT-T041-paises-D.php';</script>";
						}
					else{
						print "<script>alert(\"No se Ha podido realizar el cambio\");window.location='ABT-T023-editarPaises-U.php';</script>";
