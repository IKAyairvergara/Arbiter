<!-- 
=======================================================================================================================
==> TITULO DE ARCHIVO: editarPaises.php
...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
    ...
    <br>
    <center>
	<form id="form1" name="form1" method="post" action="editarPaises.php">
  <table class="tabla">
  <tr>
...
<?php
			...
			# Funcion para quitar las tildes de las variables ingresadas			
				...
				$PAIS_ID= $_POST['PAIS_ID'];
					...
					if($result==true){
						print "<script>alert(\"no se a podido realizar el cambio\");window.location='editarPaises.php';</script>";
						}
					else{
