...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p" onclick="location.href='../Bienvenido/bienvenido.php';" style="background-image:url(parametrizacion_03.png);" title="">
	</div>
	...
	<div id="p1" onclick="location.href='../Bienvenido/bienvenido.php';" style="background-image:url(parametrizacion_06.png);" title="">
	</div>
	...
	<div id="p3" onclick="location.href='../Ciudades/ciudades.php';"  style="background-image:url(parametrizacion_11.png); " title="">
	</div>
	...
	<div id="p4" onclick="location.href='../Segmentos/segmentos.php';" style="background-image:url(parametrizacion_13.png);" title="">
	</div>
	...
	<div id="p5" onclick="location.href='../Participacion/participacion.php';" style="background-image:url(parametrizacion_15.png); " title="">
	</div>
	...
	<div id="p2" onclick="location.href='../Paises/paises.php';" style="background-image:url(parametrizacion_18.png); " title="">
	</div>
	...
	<div id="p7" onclick="location.href='../DetalleProyecto/detalleProyecto.php';" style="background-image:url(parametrizacion_24.png); " title="">
	</div>
	...
	<div id="p8" onclick="location.href='../Indicadores/indicadores.php';"  style="background-image:url(parametrizacion_26.png); " title="">
	</div>
	...
	<div id="p9" onclick="location.href='../Servidores/servidores.php';"style="background-image:url(parametrizacion_29.png);">
	</div>
	...
	<div id="p6" onclick="location.href='../Proyectos/proyectos.php';" style="background-image:url(parametrizacion_32.png); " title="">
	</div>
