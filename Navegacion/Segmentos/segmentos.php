<!-- 
=======================================================================================================================
==> TITULO DE ARCHIVO: segmentos.php

==> DESCRIPCION: Pantalla segmentos
...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onclick="location.href='../Parametrizacion/parametrizacion.php';" style="background-image:url(segmentos_03.png); cursor:pointer;" title="">
	</div>
	<div style="background-image:url(segmentos_04.png); position:absolute; left:802px; top:41px; width:32px; height:117px;" title="">
	</div>
	<div id="p" onclick="location.href='../Bienvenido/bienvenido.php';" style="background-image:url(segmentos_05.png); cursor:pointer;" title="">
	</div>
