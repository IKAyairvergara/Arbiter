...
<body>
	<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
		...
		<div id="p1" onClick="location.href='../Segmentos/ABT-T045-segmentos-D.php';" style="background-image:url(agregar_03.png); " title="">
		</div>
		...
		<div style="background-image:url(agregar_10.png); position:absolute; left:36px; top:158px; width:954px; height:494px;" title="">
			<center>
				...
				<br>
				<br>
				<form id="form1" name="form1" method="post" action="ABT-T008-agregarSegmentos-U.php">
					<table class="tabla">
						<tr>
				...
				if($_POST["CIUD_ID"]!=""&& $_POST["SEG_DESCRIPCION"]!=""){
					...
					if($result==false){
						print "<script>alert(\"los datos estan duplicados\");window.location='ABT-T008-agregarSegmentos-U.php';</script>";
					}
					else{
						print "<script>alert(\"los datos se enviaron correctamente\");window.location='../Segmentos/ABT-T045-segmentos-D.php';</script>";
					}
