...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onClick="location.href='../Ciudades/ABT-T014-ciudades-D.php';" style="background-image:url(agregar_03.png); " title="">
	</div>
	...
	<div style="background-image:url(agregar_10.png); position:absolute; left:36px; top:158px; width:954px; height:494px;" title="">
		...
		<br>
		<center>
			<form id="form1" name="form1" method="post" action="ABT-T002-agregarCiudades-U.php">
				<table class="tabla">
					<tr>
		...
		if(isset($_POST['CIUD_ID'])&& isset($_POST["CIUD_DESCRIPCION"])&& isset($_POST["CIUD_PAISES"])){
			$CIUD_ID= $_POST['CIUD_ID'];
				...
				if($_POST["CIUD_ID"]!=""&& $_POST["CIUD_DESCRIPCION"]!=""&& $_POST["CIUD_PAISES"]!=""){
					...
					if($result==false){
						print "<script>alert(\"los datos estan duplicados\");window.location='ABT-T002-agregarCiudades-U.php';</script>";
					}
					else{
						print "<script>alert(\"los datos se enviaron correctamente\");window.location='../Ciudades/ABT-T014-ciudades-D.php';</script>";
					}
				}
				else{
					print "<script>alert(\"porfavor llenar todos los campos\");window.location='ABT-T002-agregarCiudades-U.php';</script>";
				}
