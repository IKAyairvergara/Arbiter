...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onClick="location.href='../Indicadores/indicadores.php';" style="background-image:url(agregar_03.png); " title="">
	</div>
	  ...
	  <tr>
		...
		<?php 
			...
			#Funcion para quitar las tildes de los elementos ingresados por el usuario		
				...
				# Realizar inserción del nuevo indicador en la base de datos 
