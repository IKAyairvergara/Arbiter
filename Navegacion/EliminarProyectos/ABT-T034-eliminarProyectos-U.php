...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onClick="location.href='../Proyectos/ABT-T044-proyectos-D.php';" style="background-image:url(eliminar_05.png); " title="">
	</div>
	...
	<br>
	<center>
	<form method = "post" action = "ABT-T034-eliminarProyectos-U.php">
				...
				if(isset($_POST['IND_ID'])){
					...
					if($_POST["IND_ID"]!=""){
						...
						$result = $mysqli->query($query);
							if($result==false){
								print "<script>alert(\"El registro no puede ser eliminado ya que contiene dependencias\");window.location='ABT-T034-eliminarProyectos-U.php';</script>";
								}
							else{
								print "<script>alert(\"Se ha Eliminado correctamente\");window.location='../Proyectos/ABT-T044-proyectos-D.php';</script>";
								}
							}
						}
					$mysqli->close();
