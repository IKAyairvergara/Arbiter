...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onClick="location.href='../Segmentos/ABT-T045-segmentos-D.php';" style="background-image:url(eliminar_05.png); " title="">
	</div>
	...
	<br>
	<center>
	<form method = "post" action = "ABT-T035-eliminarSegmentos-U.php">
                  <table width = "400" border = "0" cellspacing = "1" 
                     cellpadding = "2">
                     
                     <tr>
                         <td style="color: white; font-family:sans-serif;font-size:20;" >Codigo de Segmento:</td>
	...
	<?php 
	    ...
	    if(isset($_POST['IND_ID'])){
		  ...
		  $result = $mysqli->query($query);
	       if($result==false){
				print "<script>alert(\"El registro no puede ser eliminado ya que contiene dependencias\");window.location='ABT-T035-eliminarSegmentos-U.php';</script>";
				}
				else{
				print "<script>alert(\"Se ha Eliminado correctamente\");window.location='../Segmentos/ABT-T045-segmentos-D.php';</script>";
							}
			}
	     }
