<!-- 
=======================================================================================================================
==> TITULO DE ARCHIVO: editarSegmentos.php
...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<br>
	<CENTER>
	<form id="form1" name="form1" method="post" action="editarSegmentos.php">
 <table class="tabla">
  <tr>
  ...
  <tr>
	...
	if(isset($_POST['SEG_ID'])){
		...
		if($result==true){
			print "<script>alert(\"no se a podido realizar el cambio\");window.location='editarSegmentos.php';</script>";
			}
		else{
