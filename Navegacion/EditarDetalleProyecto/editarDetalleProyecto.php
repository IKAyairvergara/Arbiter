<!-- 
=======================================================================================================================
==> TITULO DE ARCHIVO: editarDetalleProyecto.php
...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<br>
	<center>
	<form id="form1" name="form1" method="post" action="editarDetalleProyecto.php">
  <table class="tabla">
  <tr>
		     ...
		     if(isset($_POST['pais'])){
				...
				if($_POST["pais"]!=""){
				  ...
				  $result = $mysqli->query($query);
					   if($result==false){
							print "<script>alert(\"ERROR\");window.location='editarDetalleProyecto.php';</script>";
							}
						else{
