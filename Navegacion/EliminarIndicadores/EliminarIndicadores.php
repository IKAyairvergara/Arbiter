<!-- 
=======================================================================================================================
==> TITULO DE ARCHIVO: eliminarIndicadores.php

==> DESCRIPCION: Pantalla que permite eliminar indicadores parametrizados en el sistema.
...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onClick="location.href='../Indicadores/indicadores.php';" style="background-image:url(eliminar_05.png); " title="">
	</div>
	...
	<form method = "post" action = "eliminarIndicadores.php">
                  <table width = "400" border = "0" cellspacing = "1" 
            		...
            		<?php
            			#icluir conexion a base de datos y servidor
