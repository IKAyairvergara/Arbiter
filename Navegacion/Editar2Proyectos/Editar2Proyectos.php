...
<br>
<center>	
<form id="form1" name="form1" method="post" action="Editar2Proyectos.php">
 <table class="tabla">
  <tr>
						...
						if($_POST["PRO_ID"]!=""){
								$update = "UPDATE tb_proyecto SET PRO_DESCRIPCION = '$PRO_DESCRIPCION3', PRO_PAI_ID = '$PR_PA_ID', PRO_CIU_ID = '$PR_CI_ID' WHERE PRO_ID = '$PRO_ID'";	
									...
									if($result==true){
										...
										print "<script>alert(\"La ciudad y el país deben coincidir con los registrados inicialmente\");window.location='Editar2Proyectos.php';</script>";
										}
