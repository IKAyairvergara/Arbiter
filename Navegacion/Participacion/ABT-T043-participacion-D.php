...
<div style="position:absolute; left:10%; top:0px; width:1024px; height:768px;">
	...
	<div id="p1" onclick="location.href='../Parametrizacion/ABT-T042-parametrizacion-D.php';" style="background-image:url(tipoParticipacion_03.png); cursor:pointer;" title="">
	</div>
	...
	<div id="p" onclick="location.href='../Bienvenido/ABT-T010-bienvenido.php';" style="background-image:url(tipoParticipacion_06.png); cursor:pointer;" title="">
	</div>
	...
	<div id="p2" onclick="location.href='../EditarParticipacion/ABT-T024-editarParticipacion-U.php';" style="background-image:url(tipoParticipacion_14.png); cursor:pointer;" title="">
	</div>
	...
	<div id="p3" onclick="location.href='../AgregarParticipacion/ABT-T006-agregarParticipacion-U.php';" style="background-image:url(tipoParticipacion_16.png); cursor:pointer;" title="">
	</div>
	...
	<div id="p4" onclick="location.href='../EliminarParticipacion/ABT-T033-eliminarParticipacion-U.php';" style="background-image:url(tipoParticipacion_19.png); cursor:pointer;" title="">
	</div>
