...
<div style="position:absolute; left:10%; top:0%; width:100%; height:100%;">
	...
	<div id="p1" onclick="location.href='../Bienvenido/bienvenido.php';" style="background-image:url(Untitled-1_06.png); " title="">
	</div>
	...
	<div id="p" onclick="location.href='../Bienvenido/bienvenido.php';" style="background-image:url(Untitled-1_11.png); " title="">
	</div>
	...
	<div id="p2" onclick="location.href='../CargaAutomatica/cargaAutomatica.php';" style="background-image:url(Untitled-1_26.png);" title="">
	</div>
